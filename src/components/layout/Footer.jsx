            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12 mb-12">
                    ...
                    <div className="lg:w-96 w-full mt-10 lg:mt-0 ml-auto">
                        <div className="flex flex-col">
                            <h3 className="text-2xl font-bold w-full text-left mb-4">SabriHelpage</h3>
                            <p className="text-white mb-6 leading-relaxed">
                                Dedicated to serving humanity through comprehensive welfare programs for the elderly, women, and children.
                            </p>
                            <h4 className="text-xl font-bold w-full text-left">Stay Updated</h4>
                        </div>
                ...
                <div className="pt-6">
                    <div className="flex flex-col md:flex-row items-center justify-between w-full gap-4">
                        {/* Social Media Icons */}
                        <div className="flex space-x-4 mb-2 md:mb-0 order-1">
                        ...
                        <div className="order-2 w-full md:w-auto flex justify-center">
                            <span className="text-white text-sm">{new Date().getFullYear()} Sabri Helpage. All rights reserved.</span>
                        </div>
                        {/* Legal Links Right */}
                        <div className="flex flex-wrap items-center justify-center md:justify-end gap-4 order-3">
                            <button onClick={() => onNavigate('about')} className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">About Us</button>
                            <button onClick={() => onNavigate('terms')} className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">Terms of Service</button>
                            <button onClick={() => onNavigate('privacy')} className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">Privacy Policy</button>
                        </div>
                    </div>
                </div>
            </div>
