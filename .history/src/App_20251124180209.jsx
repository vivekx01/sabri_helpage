...
const MentalHealthPage = ({ onNavigate }) => {
  // Define COLORS and IMAGE_URLS if they are not globally available
  const COLORS = {
    ACCENT_ORANGE: '#FF7F50', // Example color
    BG_LIGHT_GRAY: '#F7F7F7', // Example color
    PRIMARY_BLUE: '#3B82F6', // Example color
  };
  const IMAGE_URLS = {
    MENTAL_HEALTH: '/images/mental-health.jpg', // Placeholder
  };
  
  // Placeholder components (Assuming they are defined elsewhere in the project)
  const BackButton = ({ onClick }) => (
    <button 
      onClick={onClick} 
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 p-6 rounded-xl border-l-4 shadow-md" style={{ borderColor: COLORS.PRIMARY_BLUE, backgroundColor: COLORS.BG_LIGHT_GRAY }}>
          <h3 className="text-2xl font-bold mb-3 text-gray-900">1. Getting the Word Out (Awareness)</h3>
          <p className="text-lg text-gray-700 leading-relaxed">
            We work hard to teach people in our communities about **mental health**, dispel myths, and encourage open conversations. We help people understand how important **emotional health** is and lower the stigma around it through talks, campaigns, and interactive sessions.
          </p>
        </div>
        ...
        <div className="mb-10 p-6 rounded-xl border-l-4 shadow-md" style={{ borderColor: COLORS.PRIMARY_BLUE, backgroundColor: COLORS.BG_LIGHT_GRAY }}>
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 pl-4">
            <li>
              **Podcast Conversations:** Sharing real-life stories, advice, and expert opinions to connect with young people and help them become more emotionally strong.
            </li>
            <li>
              **One-on-one interactions:** Giving people personalized help so they can talk about their problems and get kind advice on how to improve their health.
            </li>
          </ul>
        </div>
...
const ElderlyCarePage = ({ onNavigate }) => {
  ...
  const IMAGE_URLS = {
    ELDERLY_CARE: '/images/elderly-care.jpg', // Placeholder
  };
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-gray-700 mb-8 leading-relaxed font-semibold" style={{ color: COLORS.PRIMARY_BLUE }}>
        ...
        <div className="p-6 rounded-xl text-center shadow-lg" style={{ backgroundColor: COLORS.ACCENT_ORANGE }}>
          ...
          <button 
            onClick={() => onNavigate('donate')} // Assuming a 'donate' page exists
...
const GirlEducationPage = ({ onNavigate }) => {
  ...
  const IMAGE_URLS = {
    GIRL_EDUCATION: '/images/girl-education.jpg', // Placeholder
  };
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-gray-700 mb-8 leading-relaxed font-semibold">
          Sabri Helpage is committed to helping young girls who are having problems with their social, economic, or emotional lives. We think that every girl, no matter what her situation is, should have **access to education, respect, and the chance to dream without limits**.
        </p>
        ...
        <div className="mb-10 p-6 rounded-xl border-l-4 shadow-md" style={{ borderColor: COLORS.PRIMARY_BLUE, backgroundColor: COLORS.BG_LIGHT_GRAY }}>
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            We give girls **sanitary pads every month** to make sure they are comfortable, clean, and able to go to school. This program helps them take care of their health with respect and keeps them from missing out on learning because they don't have the right tools, thereby maintaining **dignity and consistent attendance**.
          </p>
        </div>
