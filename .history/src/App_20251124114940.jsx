...
const AboutPage = ({onNavigate}) => (
  <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-orange-100">
    ...
    <div className="max-w-4xl mx-auto px-6 pt-20 pb-12 text-center">
      <p className="text-[#C2410C] font-bold mb-4 uppercase tracking-widest text-sm">
        Since 2013 • Kolkata, India
      </p>
      <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-8">
        Restoring Dignity.<br />
        <span className="text-[#F97316]">Building Hope.</span>
      </h1>
      <div className="h-1 w-24 bg-[#F97316] mx-auto mb-10"></div>
    </div>
    ...
    <div className="bg-[#FFF7ED] border-y border-orange-100">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg text-gray-700 max-w-none leading-relaxed space-y-6">
          ...
          <div className="bg-white p-6 border-l-4 border-[#F97316] rounded-r-lg shadow-sm my-8">
    ...
    <div className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start bg-white p-8 rounded-2xl border border-gray-100 shadow-lg shadow-orange-100/50">
          <div className="md:w-1/4 flex flex-col items-center text-center">
            <div className="w-32 h-32 rounded-full bg-[#FFF7ED] border-2 border-[#F97316] flex items-center justify-center mb-4 text-[#C2410C] text-3xl font-bold">
              AS
            </div>
            <h3 className="text-xl font-bold text-gray-900">Aarti BR Singh</h3>
            <p className="text-[#F97316] font-medium text-sm uppercase tracking-wide mt-1">Founder</p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start bg-white p-8 rounded-2xl border border-gray-100 shadow-lg shadow-orange-100/50">
          <div className="md:w-1/4 flex flex-col items-center text-center">
            ...
            <p className="text-[#F97316] font-medium text-sm uppercase tracking-wide mt-1">Philanthropist</p>
          </div>
          <div className="md:w-3/4 text-gray-600 leading-relaxed space-y-4">
            <p>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start bg-white p-8 rounded-2xl border border-gray-100 shadow-lg shadow-orange-100/50">
          <div className="md:w-1/4 flex flex-col items-center text-center">
            ...
            <p className="text-[#F97316] font-medium text-sm uppercase tracking-wide mt-1">Social Leader</p>
          </div>
          <div className="md:w-3/4 text-gray-600 leading-relaxed space-y-4">
            <p>
    ...
    {/* Footer CTA */}
    <div className="bg-[#C2410C] text-white py-16 px-6 text-center mt-12">
      <div className="max-w-3xl mx-auto">
        ...
        <button className="bg-white text-[#C2410C] font-bold px-8 py-3 rounded hover:bg-orange-50 transition-colors shadow-lg">
          Get Involved
        </button>
      </div>
    </div>
