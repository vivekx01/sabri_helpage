  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        try {
          const [home, about, sociofare, mh, elderly, girl, testimonials] = await Promise.all([
            api.getPageContent('home').catch(() => null),
            api.getPageContent('about').catch(() => null),
            api.getPageContent('sociofare').catch(() => null),
          ...
          merged.pages = { ...(merged.pages || {}), ...(home ? { home } : {}), ...(about ? { about } : {}), ...(sociofare ? { sociofare } : {}) };
          merged.causes = {
            ...(merged.causes || {}),
            ...(mh ? { 'mental-health': mh } : {}),
