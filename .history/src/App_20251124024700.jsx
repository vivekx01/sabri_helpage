...
const ILCPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      {/* --- Header / Breadcrumb Simulation --- */}
      <div className="bg-white border-b border-gray-200 py-4 px-6 mb-8">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div>
             <h2 className="text-2xl font-serif text-orange-600 font-bold">Sabri HelpAge</h2>
             <span className="text-sm text-gray-500 tracking-wide uppercase">Sabri Social Impact Club | Home</span>
          </div>
        </div>
      </div>
      ...
      <main className="max-w-5xl mx-auto px-6">
        ...
        {/* Title */}
        <h1 className="text-4xl md:text-5xl font-bold text-center text-purple-900 mb-10">
        ...
        {/* Introduction Text */}
        <div className="prose max-w-none text-lg leading-relaxed text-gray-700 font-serif mb-12">
          <p className="mb-6">
            <span className="font-bold text-orange-600">SSIC</span> is the vision of Sabri Helpage to create a caring and socially responsible community where businesses and nonprofits work together to make a difference in society that lasts.
          </p>
          <p>
      ...
      {/* --- Quote Banner (Mimicking the purple banner in image) --- */}
      <div className="w-full bg-orange-500 py-12 my-12 shadow-lg">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-2xl md:text-3xl text-white font-serif italic font-medium leading-snug">
          ...
          <p className="mt-4 text-orange-100 font-semibold tracking-wide">— SSIC Mission Vision</p>
        </div>
      </div>

      {/* --- Mission Section & CTA --- */}
      <div className="max-w-5xl mx-auto px-6 pb-20 grid md:grid-cols-3 gap-12">
        
        {/* Left: Mission Points */}
        <div className="md:col-span-2">
          <h3 className="text-2xl font-bold text-orange-600 mb-6">Our Mission</h3>
          <ul className="space-y-4">
            {[
              "Promote solutions based on research and new ways of doing things that deal with important social problems.",
              "Help businesses and non-profits share information, work together, and build their skills.",
              "Encourage people to act in a socially responsible way through structured programs and partnerships.",
              "Create a welcoming space where people can share their thoughts, resources, and chances to make society stronger."
            ].map((item, index) => (
        ...
        {/* Right: CTA Box */}
        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 shadow-sm h-fit">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Join the Movement</h3>
          <p className="text-gray-600 mb-6 text-sm">
            Become a part of the Sabri Social Impact Club and contribute to a stronger, healthier, and more caring society.
          </p>
          <button 
            onClick={toggleModal}
            className="w-full bg-purple-700 text-white px-6 py-4 rounded-xl font-bold text-lg hover:bg-purple-800 hover:shadow-lg transition-all flex items-center justify-center gap-2"
          >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative z-10 flex flex-col">
            
            {/* Modal Header */}
            <div className="sticky top-0 bg-white border-b border-gray-200 px-8 py-5 flex justify-between items-center z-20">
              <h2 className="text-2xl font-bold text-gray-800">SSIC Registration</h2>
              <button 
                onClick={toggleModal}
            ...
            <div className="p-8 space-y-8">
              ...
              <section>
                <h3 className="text-lg font-semibold text-orange-600 mb-4 border-b border-orange-100 pb-2">A. Organisation Details</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-1">Organisation Name</label>
                    <input type="text" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none" />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="orgType" className="text-orange-600 focus:ring-orange-500" />
                        <span>Corporate</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="orgType" className="text-orange-600 focus:ring-orange-500" />
                  ...
                  <div>
                    ...
                    <input type="text" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Year of Establishment</label>
                    <input type="number" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" />
                  </div>
                  <div className="md:col-span-2">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea rows="2" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none"></textarea>
                  </div>
                </div>
              </section>
              ...
              <section>
                <h3 className="text-lg font-semibold text-orange-600 mb-4 border-b border-orange-100 pb-2">B. Contact Person Details</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                  ...
                  <div>
                    ...
                    <input type="tel" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                    <input type="email" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none" />
                  </div>
                </div>
              </section>

              {/* Section C & D: Focus Areas */}
              <div className="grid md:grid-cols-2 gap-8">
                <section>
                    <h3 className="text-lg font-semibold text-orange-600 mb-4 border-b border-orange-100 pb-2">C. Membership Info</h3>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Preferred Category</label>
                    <select className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none mb-4">
                        <option>Select Membership...</option>
                        <option>Annual Membership</option>
                        <option>3-Year Membership</option>
                    </select>
                ...
                <section>
                    <h3 className="text-lg font-semibold text-orange-600 mb-4 border-b border-orange-100 pb-2">D. Focus Areas</h3>
                    <div className="grid grid-cols-2 gap-3">
                        {['Community Development', 'Research & Innovation', 'Education & Youth', 'Girl Child Empowerment', 'Sustainability', 'Social Welfare', 'Skill Development', 'Health & Well-being'].map((area) => (
              ...
              {/* Section E: Impact Activities */}
              <section>
                <h3 className="text-lg font-semibold text-orange-600 mb-4 border-b border-orange-100 pb-2">E. Social Impact Activities</h3>
                <p className="text-xs text-gray-500 mb-2">Brief summary of ongoing or past initiatives.</p>
                <textarea rows="4" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none"></textarea>
              </section>

              {/* Section F: Documents */}
              <section>
                <h3 className="text-lg font-semibold text-orange-600 mb-4 border-b border-orange-100 pb-2">F. Attach Documents</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {['Registration Certificate', 'PAN Card', 'Org Profile', 'Logo (High Res)'].map((doc) => (
                        <div key={doc} className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:bg-gray-50 hover:border-orange-400 transition-colors cursor-pointer">
                            <Upload className="w-6 h-6 mx-auto text-gray-400 mb-2" />
                            <span className="text-sm text-gray-600 block">{doc}</span>
                        </div>
                    ))}
                </div>
              </section>
            ...
            {/* Modal Footer */}
            <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-8 py-5 flex justify-end gap-4 z-20">
              <button 
                onClick={toggleModal}
              ...
              <button className="px-8 py-3 bg-orange-500 text-white font-bold rounded-full hover:bg-orange-600 transition shadow-md">
                Submit Application
              </button>
            </div>
