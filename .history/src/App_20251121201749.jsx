...
import { 
  ...
  Linkedin, Youtube, Calendar, User, MessageSquare, Briefcase, 
...
// Remaining pages from second code
const DonatePage = ({ onNavigate }) => <div className="p-20 text-center"><h1 className="text-3xl font-bold">Donate Page</h1></div>;
...
const InternshipPage = () => <div className="p-20 text-center"><h1 className="text-3xl font-bold">Internships</h1></div>;
