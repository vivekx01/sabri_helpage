...
// ==================== HEADER ====================
const Header = ({ onNavigate, COLORS }) => { // Added COLORS to props for use in mobile menu
  ...
  return (
    <header className="bg-white shadow-lg sticky top-0 z-50 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-2 md:py-4"> {/* Increased py-4 for more vertical space */}
          <button 
            onClick={() => handleNavClick('home')} 
            className="flex items-center"
            aria-label="Sabri Helpage Home"
          >
            {/* INCREASED LOGO SIZE: h-20 (80px) and md:h-32 (128px) */}
           <img 
              src="websiteLogo.jpg" 
              alt="SabriHelpAge Logo" 
              className="h-20 md:h-32 object-contain transition-transform hover:scale-105"
            />
          </button>

          <div className="hidden lg:flex items-center space-x-8"> {/* Adjusted space-x to 8 */}
            {/* IMPROVED NAV STYLING: Increased font size to 'base' (was 'sm'), used 'tracking-normal' */}
            <nav className="flex space-x-10 text-base font-semibold uppercase tracking-normal text-gray-700"> {/* Increased space-x to 10 */}
              {navItems.map(item => (
                <button
                  key={item.name}
                  onClick={() => handleNavClick(item.page)}
                  // Enhanced hover effect for better visual feedback
                  className="hover:text-orange-600 transition-colors duration-200 relative group py-2"
                >
                  {item.name}
            ...
            <button
              ...
              className="text-white px-8 py-3 rounded-full font-extrabold transition duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 text-base"
        ...
        <div className="lg:hidden absolute top-full w-full bg-white z-40 shadow-2xl border-t">
          <nav className="flex flex-col p-4 space-y-2">
            ...
            <button
              ...
              // Assuming COLORS.PRIMARY_DARK is defined in your component's scope or passed as a prop
...
const HomePage = ({ onNavigate }) => {
  ...
  return (
    <>
      ...
      <section className="relative h-[600px] md:h-[700px] flex items-center justify-center text-white text-center overflow-hidden bg-black">
        ...
        {/* Bottom Mantra Bar - Added Section */}
        <div className="absolute bottom-0 left-0 w-full bg-[#FE5E27] py-3 text-center group cursor-default z-20 transition-all duration-300">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      {/* Club Membership */}       <section className="py-24 relative overflow-hidden" style={{ backgroundColor: '#ff5c00' }}>         <div className="absolute inset-0 opacity-20 mix-blend-multiply">           <ResponsiveImage src={IMAGE_URLS.DONATE_CALLOUT} className="w-full h-full object-cover" />         </div>         <div className="max-w-4xl mx-auto px-4 relative text-center text-white">           <h2 className="text-4xl md:text-5xl font-extrabold mb-6">Join Our Impact Leaders Circle</h2>           <p className="text-xl mb-10 text-orange-50 font-medium">             Become a member of an exclusive community dedicated to sustained social change. Get regular updates, tax benefits, and invites to exclusive events.           </p>           <button             onClick={() => onNavigate('ilc')}             className="bg-white text-orange-600 px-10 py-4 rounded-full font-extrabold text-lg shadow-xl hover:bg-gray-100 transition transform hover:scale-105"           >             Register Membership           </button>         </div>       </section>
    ...
    <div className="bg-[#F5F0E8] min-h-screen pb-20">
      ...
      <div className="pt-10 pb-6 text-center">
        ...
        <h1 className="text-4xl font-serif font-bold text-gray-900">
          ...
          Contact <span className="text-[#C75C2E]">Us</span>
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <h3 className="text-2xl font-bold text-center text-gray-900 mb-10">
          ...
          Get in <span className="text-[#C75C2E]">Touch</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-2xl transition duration-300 border-2 border-[#F5F0E8] group">
            ...
            <p className="text-sm text-gray-600 mb-5 leading-relaxed">
              ...
              7 B, Mysore Road, Rashbehari Avenue,<br />Kolkata - 700026
...
const ILCPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <div className="bg-[#FF7F50] text-white py-4 px-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold">Sabri Social Imapccct Club</h1>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#FF7F50] mb-4">
            Welcome to Sabri Social Imapccct Club!
          </h2>
        ...
        <div className="prose max-w-none text-gray-700 leading-relaxed text-justify mb-16">
          ...
          <p className="text-lg">
            The Sabri Social Imapccct Club wants to see a future where people work together to help weak communities, give youth power, support girls, and make India's environmental and social welfare system stronger.
          </p>
        </div>
            ...
            <div className="overflow-y-auto p-6 space-y-8 custom-scrollbar">
                        ...
                        <div className="relative flex-1">
                            <input 
                                ...
                                className={`w-full p-3 bg-white border rounded-lg focus:ring-2 outline-none transition-colors ${
                                    ...
                                    : "border-[#FFE4D6] focus:ring-[#FF7F50]"
                                }`} 
                    ...
                    {showOtpInput && !isPhoneVerified && (
                         <div className="mt-3 flex flex-col sm:flex-row gap-3 animate-fade-in-up">
                            <input 
                                ...
                                className="flex-1 p-3 bg-white border border-[#FFE4D6] rounded-lg focus:ring-2 focus:ring-[#FF7F50] outline-none" 
                                placeholder="Enter 4-digit OTP" 
                            />
                            <button 
                                onClick={handleVerifyOtp}
                                className="px-6 py-3 bg-[#FF7F50] text-white font-medium rounded-lg hover:bg-[#E67347] transition-colors whitespace-nowrap"
                            >
                                Verify OTP
                            </button>
                         </div>
              ...
              <section className="bg-white rounded-lg p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-3 text-[#FF7F50]">
                  ...
                  <h3 className="font-bold text-lg">E. Social Imapccct Activities</h3>
                </div>
                ...
                <textarea rows="4" className="w-full p-3 bg-white border border-[#FFE4D6] rounded-lg focus:ring-2 focus:ring-[#FF7F50] outline-none resize-none" placeholder="Describe your social imapccct projects, beneficiaries, and outcomes..."></textarea>
              </section>
...
const OurCausesLandingPage = ({ onNavigate }) => (
  <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-orange-100">
    ...
    {/* Cause 1: Mental Health (Moved to Top) */}
    <div className="bg-[#FFF7ED] border-y border-orange-100">
    ...
    {/* Cause 2: Elderly Care (Moved to Middle) - Changed bg to white for contrast */}
    ...
    {/* Cause 3: Education & Girl Child (Moved to Bottom) - Changed bg to Light Orange */}
    <div className="bg-[#FFF7ED] border-y border-orange-100">
      <div className="max-w-5xl mx-auto px-6 py-20 flex flex-col md:flex-row gap-12 items-start">
        <div className="md:w-1/3">
          <div className="inline-block px-3 py-1 bg-white border border-orange-200 text-[#C2410C] text-xs font-bold uppercase rounded-full mb-4">
...
const MentalHealthPage = ({ onNavigate, COLORS, ResponsiveImage, BackButton, IMAGE_URLS }) => {
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg text-gray-700 mb-8 leading-relaxed">
          **Sabri Helpage thinks that mental health is an important part of being healthy.** We are dedicated to putting mental health in the spotlight with care and purpose at a time when emotional problems are often hidden by fear, stigma, or a lack of understanding. Our work is based on awareness, connection, and real human support. This makes sure that people, especially young people, feel safe, heard, and understood.
        </p>
        
        <h2 className="text-3xl font-bold text-gray-800 mb-4" style={{ color: COLORS.ACCENT_ORANGE }}>Our Programs for Mental Health</h2>
        
        {/* UPDATED PROGRAM LIST */}
        <ul className="list-disc list-inside space-y-5 text-gray-700 mb-10">
          
          <li>
            <strong className="text-gray-900">Getting the Word Out (Awareness):</strong> We work hard to teach people in our communities about mental health, dispel myths, and encourage open conversations. We help people understand how important emotional health is and lower the stigma around it through talks, campaigns, and interactive sessions.
          </li>
          
          <li>
            <strong className="text-gray-900">Program for the Mental Health of College Students:</strong> We run structured mental health programs in colleges because we know that stress, anxiety, and emotional pressure are rising among young adults. These include awareness sessions, expressive activities, safe-space discussions, and early emotional screening to help students figure out what their mental health needs are and how to deal with them.
          </li>
          
          <li>
            <strong className="text-gray-900">Making a Network of People Who Will Help You (Support Pathways):</strong> We make support pathways by:
            <ul className="list-disc list-inside ml-6 mt-2 space-y-2">
              <li>**Podcast Conversations:** Sharing real-life stories, advice, and expert opinions to connect with young people and help them become more emotionally strong.</li>
              <li>**One-on-one interactions:** Giving people personalised help so they can talk about their problems and get kind advice on how to improve their health.</li>
            </ul>
          </li>
        </ul>
        ...
        <p className="text-lg text-gray-700 mb-10 leading-relaxed italic">
          Sabri Helpage's goal is to build a society that is more emotionally aware and supportive by putting mental health at the centre of everything we do. We want people to feel safe asking for help, being themselves, and growing with dignity and strength.
        </p>

        {/* CALL TO ACTION SECTION (Slightly modified to be generic contact) */}
        <div className="p-6 rounded-xl text-center shadow-inner" style={{ backgroundColor: COLORS.BG_LIGHT_GRAY }}>
          ...
          <p className="text-lg text-gray-700 mb-4">You are not alone. Reach out for confidential support or learn how to help our mission.</p>
          <a 
            href="mailto:info@sabrihelpage.org"
...
const ElderlyCarePage = ({ onNavigate, COLORS, ResponsiveImage, BackButton, IMAGE_URLS }) => {
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <BackButton onClick={() => onNavigate('home')} />
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-4" style={{ color: COLORS.ACCENT_ORANGE }}>The Most Important Services We Offer to Seniors</h2>
        
        <ul className="list-disc list-inside space-y-5 text-gray-700 mb-10">
          
          {/* SERVICE 1: Full Eye Care */}
          <li>
            <strong className="text-gray-900">Full Eye Care:</strong> Regular eye exams, early detection of vision problems, and full support for needed surgeries all help seniors get their vision back, feel more confident, and be more independent.
          </li>
          
          {/* SERVICE 2: Important Medication Help */}
          <li>
            <strong className="text-gray-900">Important Medication Help:</strong> Helping older people get the medicines they need to manage chronic illnesses, which will improve their daily lives and keep their health stable in the long term.
          </li>
          
          {/* SERVICE 3: Nourishing Food Programs */}
          <li>
            <strong className="text-gray-900">Nourishing Food Programs:</strong> Giving seniors balanced nutritional support to make sure they get the vitamins and minerals they need for strength, immunity, and general health.
          </li>
        </ul>
...
const GirlEducationPage = ({ onNavigate, COLORS, ResponsiveImage, BackButton, IMAGE_URLS }) => {
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <BackButton onClick={() => onNavigate('home')} />
        ...
        />
        {/* UPDATED MAIN HEADING */}
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">Support for the Girl Child</h1>
        ...
        {/* UPDATED PROGRAM PILLARS HEADING */}
        <h2 className="text-3xl font-bold text-gray-800 mb-4" style={{ color: COLORS.ACCENT_ORANGE }}>Our Main Goals for Girls in Need</h2>
        
        {/* UPDATED LIST ITEMS */}
        <ul className="list-disc list-inside space-y-5 text-gray-700 mb-10">
          
          <li>
            <strong className="text-gray-900">Helping Girls Get an Education:</strong> At the center of our mission is education. Sabri Helpage makes sure that girls in need get regular help with their schoolwork, the things they need for school, and advice that gives them the confidence to keep studying. We help them move towards a life full of opportunities and independence by giving them a stronger educational base.
          </li>
          
          <li>
            <strong className="text-gray-900">Help with Sanitary Pads Every Month:</strong> We give girls sanitary pads every month to make sure they are comfortable, clean, and able to go to school. We know that many girls have trouble with their periods. This program helps them take care of their health with respect and keeps them from missing out on learning because they don't have the right tools.
          </li>
        </ul>
        
        {/* NEW CLOSING PARAGRAPH BEFORE CALL TO ACTION */}
        <p className="text-lg text-gray-700 mb-10 leading-relaxed italic">
        ...
        {/* CALL TO ACTION REMAINS THE SAME (Sponsor Now) */}
        <div className="p-6 rounded-xl text-center shadow-inner" style={{ backgroundColor: COLORS.BG_LIGHT_GRAY }}>
          <h3 className="text-2xl font-bold mb-3 text-gray-900">Support Our Girl Child Program</h3>
          <p className="text-lg text-gray-700 mb-4">Your contribution helps us provide essential educational and sanitary support to girls in need.</p>
          <button 
            onClick={() => onNavigate('donate')}
            className="text-white px-8 py-3 rounded-full font-bold transition duration-300 shadow-md hover:opacity-90"
            style={{ backgroundColor: COLORS.ACCENT_ORANGE }}
...
const App = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case '<FaHome />': return <HomePage onNavigate={handleNavigate} />;
