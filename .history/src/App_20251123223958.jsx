        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-6 md:p-8 rounded-xl shadow-2xl h-full flex flex-col transition-transform hover:scale-[1.01] duration-500" style={{ backgroundColor: COLORS.ACCENT_ORANGE }}>

                <p className="text-sm font-semibold uppercase tracking-widest text-white mb-2 opacity-90">OUR MILESTONES</p>

                <h3 className="text-3xl sm:text-4xl font-extrabold text-white mb-6 md:mb-8 leading-tight">
                  We've Accomplished Most During This Span.
                </h3>

                {/* IMPROVEMENT: Changed to grid-cols-1 on mobile, 3 on larger screens */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mt-auto">
                  ...
                  {[
                    ...
                    <div 
                      key={idx} 
                      className="p-3 rounded-lg text-center transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg border border-white/10" 
                      style={{ backgroundColor: COLORS.PRIMARY_DARK }}
                    >
            ...
            <div className="flex flex-col h-full">
              ...
              {/* Added 'group' to handle hover effects for the button */}
              <div className="relative w-full shadow-2xl rounded-2xl overflow-hidden h-96 group">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="absolute bottom-6 right-6 z-10 flex items-center gap-3 bg-white pl-2 pr-5 py-2 rounded-full shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:-translate-y-1"
                >
                  {/* Red Icon Circle */}
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-gray-500 uppercase leading-none mb-0.5">Subscribe</span>
