...
const Footer = () => {
    ...
    const linksColumn4 = ["Career", "Feedback", "Events", "Videos"];
    const linksColumn5 = ["About Us", "Terms", "Privacy", "Support"];

    return (
        <footer className="w-full bg-[#0B0D17] text-white pt-16 pb-6 font-sans antialiased">
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 text-[15px] font-medium text-gray-300">
                            ...
                            <ul className="space-y-4">
                                {linksColumn4.map((item, i) => <li key={i}><a href="#" className="hover:text-white hover:underline decoration-orange-500 underline-offset-4 transition">{item}</a></li>)}
                            </ul>
                            <ul className="space-y-4">
                    ...
                    <div className="w-full lg:w-80 flex flex-col items-center lg:items-start text-center lg:text-left pt-2">
                        ...
                        {/* Pill Badge */}
                        <div className="border border-[#D98E73] rounded-full px-5 py-1.5 mb-5">
                            <span className="text-[10px] font-bold text-[#D98E73] uppercase tracking-[0.2em]">
                        ...
                        <div className="w-full h-4 mb-6 opacity-30">
                            <svg width="100%" height="100%" viewBox="0 0 100 10" preserveAspectRatio="none">
                                <path d="M0 5 Q 25 0, 50 5 T 100 5" stroke="white" strokeWidth="1" fill="none" />
                            </svg>
                        </div>

                        <p className="text-lg font-serif mb-4 text-gray-200">Subscribe to our newsletter!</p>
                        ...
                        <div className="relative w-full max-w-xs mx-auto lg:mx-0">
                            <input 
                                ...
                                className="w-full bg-[#1A1F2E] text-sm text-gray-300 rounded-full py-3.5 pl-5 pr-14 focus:outline-none focus:ring-2 focus:ring-[#F4D03F]"
                            />
                            <button className="absolute right-1.5 top-1.5 bottom-1.5 w-10 h-10 bg-[#F4D03F] hover:bg-[#eac124] rounded-full flex items-center justify-center text-black transition-colors">
