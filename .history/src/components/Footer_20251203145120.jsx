        ...
        <footer className="bg-gray-900 text-white pt-12 pb-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-10 min-h-full">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-x-14 gap-y-12">
                            <ul className="space-y-5">
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Search a Doctor</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Search a Clinic</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Insurance & Pricing</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">FAQs</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Contact</a></li>
                            </ul>
                            <ul className="space-y-5">
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Survey</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Course</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Self Understanding</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Campus</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Workplace</a></li>
                            </ul>
                            <ul className="space-y-5">
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Disorder</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Therapy</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Psychoactive Drugs</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Franchise</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Jobs</a></li>
                            </ul>
                            <ul className="space-y-5">
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Career</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Feedback</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Events</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Videos</a></li>
                            </ul>
                            <ul className="space-y-5">
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">About Us</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Terms</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Privacy</a></li>
                                <li><a href="#" className="block w-full px-5 py-3 rounded-md text-gray-300 hover:text-white hover:bg-white/5 transition duration-300">Support</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            {/* Bottom Section */}
            <div className="mt-0 pt-8 border-t border-gray-800">
