        ...
        <footer className="pt-12 pb-6" style={{ backgroundColor: COLORS.PRIMARY }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                    ...
                    {/* Brand + Newsletter compact on right */}
                    <div className="md:col-span-1 md:justify-self-end w-full max-w-sm">
                        <button onClick={() => onNavigate?.('home')} className="flex flex-col items-start mb-4">
                        ...
                        <div className="flex">
                            <input
                                ...
                                className="bg-white/10 border border-white/20 text-white px-3 py-2 rounded-l-lg w-full focus:outline-none focus:border-orange-500"
                            />
                ...
                {/* Bottom row: social left, copyright center, terms right */}
                <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center md:items-start gap-4">
                    ...
                    <div className="flex-1 text-center text-xs text-white">© 2025 Sabri Helpage. All rights reserved.</div>
