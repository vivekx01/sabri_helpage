...
import { PRIMARY_DARK, ACCENT_ORANGE, IMAGE_URLS } from '../../constants/config';

const SocioFareSection = () => (
    <section id="sociofare" className="py-20 md:py-28 relative" style={{ backgroundColor: PRIMARY_DARK }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex justify-center">
                <div className={`text-white p-8 rounded-2xl shadow-2xl max-w-md`} style={{ backgroundColor: ACCENT_ORANGE }}>
