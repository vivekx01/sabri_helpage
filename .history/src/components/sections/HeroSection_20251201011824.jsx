...
const HeroSection = ({ onReadMoreClick, onDonateClick }) => {
    ...
    const bg = (config?.heroImages && config.heroImages[0]) || IMAGE_URLS.HERO;
    return (
        <section id="home" className={`relative h-[600px] sm:h-[650px] md:h-[750px] flex items-center justify-center text-white text-center overflow-hidden`} style={{ backgroundColor: COLORS.PRIMARY_DARK }}>
            ...
            <div className="relative z-10 p-4 max-w-5xl mx-auto">
                <p className={`text-base font-semibold mb-2 uppercase tracking-widest`} style={{ color: COLORS.ACCENT_ORANGE }}>Sabri Helpage</p>
                <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black mb-6 leading-tight tracking-tight" style={{ textShadow: '4px 4px 8px rgba(0,0,0,0.5)' }}>
                    Serving society for <br className="hidden md:inline"/> more than a decade.
                </h1>
                ...
                <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                    <button 
                        ...
                        className={`text-white px-8 py-3 rounded-full text-md font-bold transition duration-300 shadow-xl`}
