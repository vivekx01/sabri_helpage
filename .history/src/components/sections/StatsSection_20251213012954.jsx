    ...
    return (
        <section className="py-20 md:py-36" style={{ backgroundColor: BG_LIGHT_GRAY }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className={`p-8 md:p-14 rounded-2xl shadow-2xl h-auto md:h-80 flex flex-col justify-between`} style={{ backgroundColor: PRIMARY }}>
                    <p className={`text-sm font-semibold uppercase tracking-wider mb-2 text-white`}>Our Milestones</p>
                    <h3 className={`text-2xl sm:text-3xl md:text-4xl font-extrabold mb-8 text-white`}>
