...
const HeroSection = ({ onReadMoreClick, onDonateClick }) => {
    ...
    return (
        <section id="home" className={`relative -mt-1 min-h-[calc(100vh-70px)] flex items-center justify-center text-white text-center overflow-hidden`} style={{ backgroundColor: COLORS.PRIMARY_DARK }}>
