    ...
    <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div id="about" className='order-first md:order-last'>
                <p className={`font-bold uppercase tracking-widest mb-2 text-sm`} style={{ color: COLORS.PRIMARY }}>What We Stand For</p>
                <h2 className={`text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-6`} style={{ color: COLORS.TEXT_DARK }}>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
                    <a href="#" className={`text-white px-8 py-3 rounded-full font-bold transition duration-300 shadow-lg`} style={{ backgroundColor: COLORS.PRIMARY }}>
                        View More
                    </a>
                    <a href="#" className={`flex items-center font-semibold transition duration-300`} style={{ color: COLORS.TEXT_DARK }}>
                        <Play className={`w-6 h-6 mr-2`} style={{ color: COLORS.PRIMARY, fill: COLORS.PRIMARY }} /> Watch Video
                    </a>
                </div>
            </div>
        </div>
