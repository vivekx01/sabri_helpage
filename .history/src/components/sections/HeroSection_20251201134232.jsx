...
const HeroSection = ({ onReadMoreClick, onDonateClick }) => {
    ...
    return (
        <section id="home" className={`relative min-h-[100vh] flex items-center justify-center text-white text-center overflow-hidden`} style={{ backgroundColor: COLORS.PRIMARY_DARK }}>
            <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.35) 40%, rgba(0,0,0,0.35) 60%, rgba(0,0,0,0.6) 100%)' }}></div>
            </div>
            
            <div className="relative z-10 p-4 max-w-5xl mx-auto">
                <p className={`text-base font-semibold mb-3 uppercase tracking-widest`} style={{ color: COLORS.PRIMARY }}>Sabri Helpage</p>
