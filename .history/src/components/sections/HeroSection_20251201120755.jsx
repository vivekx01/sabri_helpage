...
const HeroSection = ({ onReadMoreClick, onDonateClick }) => {
    ...
    return (
        <section id="home" className={`relative h-[640px] sm:h-[700px] md:h-[820px] flex items-center justify-center text-white text-center overflow-hidden`} style={{ backgroundColor: COLORS.PRIMARY_DARK }}>
