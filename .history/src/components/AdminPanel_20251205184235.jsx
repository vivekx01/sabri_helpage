                  ...
                  {filteredPages.map((page, idx) => (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <h3 className="font-semibold text-gray-900 text-sm truncate pr-6">{page}</h3>
                  ...
                  <div className="flex-1 flex flex-col border-b lg:border-b-0 lg:border-r border-gray-100">
                    ...
                    <div className="flex-1 p-6 bg-gray-50/30 overflow-y-auto">
                      <textarea
                        ...
                        defaultValue={`import React from 'react';\n\nconst ${selectedPage.replace('.jsx', '')} = () => {\n  return (\n    <div className=\"container mx-auto px-4 py-8\">\n      <h1 className=\"text-4xl font-bold\">New Page</h1>\n      <p className=\"mt-4 text-lg text-gray-600\">Start building your content here.</p>\n    </div>\n  );\n};\n\nexport default ${selectedPage.replace('.jsx', '')};`}
                      />
                    </div>
                  </div>
