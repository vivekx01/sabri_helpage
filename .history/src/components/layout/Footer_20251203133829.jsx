...
const Footer = ({ onNavigate }) => {
  ...
  return (
    <footer className="pt-16 pb-6" style={{ backgroundColor: COLORS.PRIMARY }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-3">
              {footerLinks.quickLinks.map(link => (
                <button
                  ...
                  className="text-white hover:translate-x-1 transition-all duration-200 text-sm flex items-center text-left"
                >
          ...
          {/* Right: Sabri Helpage brand + Stay Updated below */}
          <div>
            <button
            ...
            <div>
              ...
              <p className="text-white text-sm mb-4">Subscribe to our newsletter for the latest impact stories.</p>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your Email"
                  className="bg_white/10 border border-white/20 text-white px-4 py-2 rounded-l-lg w-full focus:outline-none focus:border-orange-500"
                />
                <button className="text-white px-4 py-2 rounded-r-lg font-bold transition" style={{ backgroundColor: '#fff', color: COLORS.PRIMARY }}>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center md:items-start gap-6">
          ...
          <div className="flex-1 flex md:justify-end justify-center space-x-6 text-xs text-white">
