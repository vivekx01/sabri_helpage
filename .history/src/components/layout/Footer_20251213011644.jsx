            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 w-full">
                        ...
                        {/* Copyright and Legal Links in one line */}
                        <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
                            <span className="text-white">{new Date().getFullYear()} Sabri Helpage. All rights reserved.</span>
                            <button onClick={() => onNavigate('about')} className="text-white hover:text-gray-200 transition duration-300 font-medium">About Us</button>
                            <button onClick={() => onNavigate('terms')} className="text-white hover:text-gray-200 transition duration-300 font-medium">Terms of Service</button>
                            <button onClick={() => onNavigate('privacy')} className="text-white hover:text-gray-200 transition duration-300 font-medium">Privacy Policy</button>
                        </div>
                    </div>
                </div>
            </div>
