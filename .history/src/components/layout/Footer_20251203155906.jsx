            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-x-8 gap-y-6 items-stretch">
              {footerLinks.quickLinks.map(link => (
                <button
                  ...
                  className="text-white bg-white/5 hover:bg-white/10 rounded-md px-4 py-3 transition-all duration-200 text-sm flex items-center text-left leading-tight w-full h-full"
                >
