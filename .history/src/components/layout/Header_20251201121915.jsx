  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-[0.09rem] md:py-[0.135rem]">
          <button 
          ...
          >
            <img 
              ...
              className="object-contain transition-transform hover:scale-105 h-[4.554rem] md:h-[6.07rem]"
            />
          </button>
