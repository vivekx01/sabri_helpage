  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-[0.071rem] md:py-[0.107rem]">
          <button 
          ...
          >
            <img 
              ...
              className="object-contain transition-transform hover:scale-105 h-[4.41rem] md:h-[5.876rem]"
            />
          </button>
