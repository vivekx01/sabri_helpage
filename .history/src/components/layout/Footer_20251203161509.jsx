  ...
  return (
    <footer className="pt-12 pb-6" style={{ backgroundColor: COLORS.PRIMARY }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-4 items-start">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
              {footerLinks.categories.map((cat) => (
                <div key={cat.title} className="min-w-0">
                  <h5 className="text-sm font-semibold tracking-wide text-white/80 mb-3">
                    {cat.title}
                  </h5>
        ...
        <div className="border-t border-white/10 pt-4 flex flex-col md:flex-row justify-between items-center md:items-start gap-4">
          ...
          <div className="flex-1 flex md:justify-end justify-center space-x-6 text-sm md:text-base text-white font-semibold">
