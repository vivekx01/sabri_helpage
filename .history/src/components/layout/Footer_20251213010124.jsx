            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-12 mb-12">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-3 mt-6">
                            {/* Column 1 */}
                            <ul className="space-y-3">
                                ...
                                <li><button onClick={() => onNavigate('donate')} className="text-white hover:text-gray-200 transition duration-200 text-left w-full flex items-center">› Support a Cause → Donate</button></li>
                            ...
                            {/* Column 2 */}
                            <ul className="space-y-3">
                                <li><button onClick={() => onNavigate('volunteer')} className="text-white hover:text-gray-200 transition duration-200 text-left w-full flex items-center">› Volunteer</button></li>
                    ...
                    <div className="lg:w-96 ml-auto">
                        ...
                        <form onSubmit={handleSubmit} className="flex">
                            <input
                                ...
                                className="flex-1 px-4 py-3 bg-white text-gray-800 rounded-l-lg focus:outline-none placeholder-gray-500"
                                required
                            />
                            <button
                                type="submit"
                                className="px-4 py-3 bg-white text-primary rounded-r-lg transition duration-300 hover:bg-gray-100"
                            >
