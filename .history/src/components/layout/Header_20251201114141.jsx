  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-[0.425rem] md:py-[0.6375rem]">
          <button 
          ...
          >
            <img 
              ...
              className="object-contain transition-transform hover:scale-105 h-[5.175rem] md:h-[6.9rem]"
            />
          </button>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <button
              ...
              className="text-white px-6 py-2 rounded-full font-extrabold transition duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 text-sm md:text-base bg-[#FF8F5C]"
            >
              Donate Now
            </button>
          </div>
