    ...
    return (
        <footer className="bg-gray-900 text-white pt-8 pb-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Main Footer Content - Using flex for proper spacing */}
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8 mb-8">
                    {/* Quick Links Section - Takes remaining space */}
                    <div className="flex-1">
                        <h4 className="text-lg font-semibold mb-4 text-gray-200">Quick Links</h4>
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-x-12 gap-y-3">
                            {/* Column 1 */}
                    ...
                    {/* Newsletter Section - Fixed width, pushed to the right */}
