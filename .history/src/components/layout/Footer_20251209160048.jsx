    ...
    categories: [
      {
        ...
        items: [
          ...
          // Volunteer and Clubs (SSIC) are not defined in App.jsx navigation, so keep as is or update if needed
      ...
      },
      {
        ...
        items: [
          // Support a Cause is not defined in App.jsx navigation, so keep as is or update if needed
      ...
      },
      {
        ...
        items: [
          ...
          // Media is not defined in App.jsx navigation, so keep as is or update if needed
    ...
    <footer className="pt-12 pb-6" style={{ backgroundColor: COLORS.PRIMARY }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
        ...
        <div className="border-t border-white/10 pt-0 flex flex-col md:flex-row justify-between items-center md:items-center gap-4 px-2 md:px-4">
          ...
          <div className="flex-1 flex md:justify-end justify-center space-x-6 text-sm md:text-base text-white font-semibold pr-8 md:pr-16 lg:pr-24 xl:pr-28 2xl:pr-32">
