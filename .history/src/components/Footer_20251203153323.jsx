...
const Footer = () => {
    ...
    const quickLinks = [
        ...
        ["Events", "Publications", "Media", "Contact"],
            ...
            <div className="mt-12 pt-6 border-t border-gray-800 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div className="flex space-x-6 order-2 md:order-1">
                        ...
                        <a href="#" className="text-gray-400 hover:text-orange-400 transition duration-300"><Linkedin className="w-5 h-5" /></a>
                        <a href="#" className="text-gray-400 hover:text-orange-400 transition duration-300"><Twitter className="w-5 h-5" /></a>
                        <a href="#" className="text-gray-400 hover:text-orange-400 transition duration-300"><Facebook className="w-5 h-5" /></a>
                        <a href="#" className="text-gray-400 hover:text-orange-400 transition duration-300"><Instagram className="w-5 h-5" /></a>
                    </div>
                    ...
                    {/* Footer Links (separated Terms and Privacy) */}
                    <div className="order-3 text-right w-full md:w-auto">
                        <div className="flex md:flex-col flex-row md:space-y-2 space-x-6 md:space-x-0">
