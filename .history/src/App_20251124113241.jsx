  ...
  <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-orange-100">
    ...
    <div className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
      ...
      <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-8">
        Charity is not a duty.<br />
        <span className="text-[#F97316]">It is a responsibility.</span>
      </h1>
      <div className="h-1 w-24 bg-[#F97316] mx-auto mb-8"></div>
      <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
        Operating independently of political or religious influence in Kolkata, we focus on the invisible members of our society—from abandoned seniors to street children denied their dignity.
      </p>
    </div>
    ...
    <div className="bg-white py-12 px-6">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-6 text-[#C2410C] font-semibold text-sm">
