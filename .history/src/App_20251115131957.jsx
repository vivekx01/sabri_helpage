...
const EducationIcon = (props) => <BookOpen className="w-10 h-10 mx-auto text-blue-600 mb-2" {...props} />;
const HealthIcon = (props) => <Activity className="w-10 h-10 mx-auto text-red-600 mb-2" {...props} />; // Using Activity for a "health" feel
const VerifiedIcon = (props) => <Star className="w-4 h-4 mr-1 text-green-600" fill="currentColor" {...props} />;
const CheckMarkIcon = (props) => (
    // Simple SVG checkmark for better control over styling
