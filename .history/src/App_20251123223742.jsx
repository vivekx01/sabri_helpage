        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <div className="p-6 md:p-8 rounded-xl shadow-2xl h-full flex flex-col relative overflow-hidden" style={{ backgroundColor: COLORS.ACCENT_ORANGE }}>
                {/* Subtle decorative circle for UI depth */}
                ...
                <p className="text-sm font-semibold uppercase tracking-widest text-white mb-2 relative z-10">OUR MILESTONES</p>

                <h3 className="text-3xl sm:text-4xl font-extrabold text-white mb-6 md:mb-8 relative z-10">
                  We've Accomplished Most During This Span.
                </h3>

                {/* IMPROVEMENT: Changed to grid-cols-1 on mobile, grid-cols-3 on small screens and up */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mt-auto relative z-10">
                  {[
                    ...
                    <motion.div 
                      ...
                      className="p-3 rounded-lg text-center border border-white/10 backdrop-blur-sm transition-all duration-300" 
                      style={{ backgroundColor: COLORS.PRIMARY_DARK }}
                    >
            ...
            {/* Right Column: Video & YouTube Button */}
            <motion.div 
              className="flex flex-col h-full"
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <div className="relative w-full shadow-2xl rounded-2xl overflow-hidden h-96 group bg-black">
                
                <YoutubeEmbed videoId={YOUTUBE_VIDEO_ID} title="Sabri Helpage Story" />

                {/* --- THE NEW COOL YOUTUBE BUTTON --- */}
                {/* This floats over the video in the bottom right corner */}
                <a 
                  href="https://www.youtube.com/@YourChannelHandle" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="absolute bottom-5 right-5 z-20 flex items-center gap-3 bg-white/90 backdrop-blur-md pr-4 pl-2 py-2 rounded-full shadow-lg hover:scale-105 hover:bg-white transition-all duration-300 group/btn cursor-pointer"
                >
                  {/* Icon Circle */}
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-gray-500 uppercase leading-none">Subscribe</span>
                    <div className="flex items-center gap-1">
                      <span className="text-sm font-bold text-gray-900">Our Channel</span>
