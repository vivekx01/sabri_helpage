      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <button 
            ...
            className="flex items-center text-sm font-semibold text-gray-500 hover:text-teal-700 transition-colors"
          >
            <ArrowLeft size={18} className="mr-2" />
            {step === 2 ? "Back to Amount" : "Back to Home"}
          </button>
          <div className="flex items-center gap-2 text-teal-700 font-bold tracking-tight">
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              ...
              <motion.div variants={fadeIn} className="lg:col-span-7 flex flex-col justify-center">
                <div className="inline-flex items-center self-start px-3 py-1 rounded-full bg-orange-100 text-orange-700 text-xs font-bold tracking-wide mb-6">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-xl leading-relaxed">
                  Your contribution bridges the gap between despair and hope. Join us in building a compassionate world where every elderly person thrives with dignity.
                </p>

                {/* Stats Row */}
                <div className="grid grid-cols-3 gap-4 mb-10">
                  <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                    <div className="text-3xl font-bold text-teal-700">50K+</div>
                    <div className="text-xs text-gray-500 font-bold uppercase mt-1">Lives Touched</div>
                  </div>
                  <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                    <div className="text-3xl font-bold text-teal-700">25</div>
                    <div className="text-xs text-gray-500 font-bold uppercase mt-1">Regions</div>
                  </div>
                  <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                    <div className="text-3xl font-bold text-teal-700">10+</div>
                    <div className="text-xs text-gray-500 font-bold uppercase mt-1">Years</div>
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    <CheckCircle className="text-green-500" size={18} /> 100% Transparent
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    <CheckCircle className="text-green-500" size={18} /> Verified NGO
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    <CheckCircle className="text-green-500" size={18} /> 80G Tax Exempt
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeIn} className="lg:col-span-5">
                <div className="bg-white rounded-3xl shadow-2xl shadow-teal-900/10 overflow-hidden border border-gray-100">
                  <div className="p-1 bg-gradient-to-r from-teal-500 to-emerald-400"></div>
                    ...
                    <form className="space-y-6">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          min="100"
                          className={`w-full pl-10 pr-4 py-4 rounded-xl text-lg font-semibold bg-gray-50 border-2 transition-all outline-none ${
                            finalAmount > 0 && customAmount && amount === 0 
                      ...
                      <SelectField 
                        ...
                        options={['Elderly Care', 'Education', 'Mental Health', 'General Fund']}
                        icon={Heart}
                      />
                      ...
                      <div className="bg-gray-100 p-1.5 rounded-xl flex relative">
                        <div 
                          className="absolute h-[calc(100%-12px)] w-[calc(50%-6px)] top-1.5 bg-white rounded-lg shadow-sm transition-all duration-300 ease-out"
                          style={{ left: isRecurring ? 'calc(50% + 3px)' : '6px' }}
                        />
                        <button
                          type="button"
                          onClick={() => setIsRecurring(false)}
                          className={`flex-1 relative z-10 py-2 text-sm font-bold transition-colors ${!isRecurring ? 'text-gray-900' : 'text-gray-500'}`}
                        >
                          One-time
                        </button>
                        <button
                          ...
                          className={`flex-1 relative z-10 py-2 text-sm font-bold flex items-center justify-center gap-2 transition-colors ${isRecurring ? 'text-teal-700' : 'text-gray-500'}`}
                        >
                          Monthly <span className="text-[10px] bg-teal-100 text-teal-800 px-1.5 py-0.5 rounded-full">Care</span>
                        </button>
                      </div>
                      ...
                      <motion.button
                        ...
                        className="w-full py-4 rounded-xl text-lg font-bold text-white shadow-xl shadow-orange-500/20 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                      >
              ...
              {/* Focus Areas - Bottom Section */}
              <motion.div variants={fadeIn} className="col-span-1 lg:col-span-12 pt-8">
                <h3 className="text-xl font-bold text-gray-800 mb-6 text-center">Our Impact Areas</h3>
                <div className="grid md:grid-cols-3 gap-6">
                  <FeatureCard 
                    icon={Heart} 
                    title="Mental Health" 
                    desc="Providing counseling and healthcare support." 
                    color="bg-orange-100 text-orange-600"
                  />
                  <FeatureCard 
                    icon={Users} 
                    title="Elderly Care" 
                    desc="Ensuring dignity and daily support for seniors." 
                    color="bg-teal-100 text-teal-600"
                  />
                  <FeatureCard 
                    icon={BookOpen} 
                    title="Education" 
                    desc="Empowering the girl child through knowledge." 
            ...
            >
              <div className="bg-white rounded-3xl shadow-2xl shadow-gray-200/50 overflow-hidden border border-gray-100">
                ...
                <div className="bg-gray-900 text-white p-8">
                  ...
                  <p className="text-gray-400 mb-6">Fill in your details to complete your tax-exempt donation.</p>
                  ...
                  <div className="flex items-center gap-4 bg-gray-800/50 p-4 rounded-xl border border-gray-700/50">
                    ...
                    <div>
                      <div className="text-sm text-gray-400">You are donating</div>
                      <div className="text-xl font-bold">₹{finalAmount.toLocaleString('en-IN')} <span className="text-sm font-normal text-gray-500">({isRecurring ? 'Monthly' : 'One-time'})</span></div>
                    </div>
                    <div className="ml-auto text-right hidden sm:block">
                      <div className="text-sm text-gray-400">Towards</div>
                      <div className="text-teal-400 font-medium">{supportCategory}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {/* Section: Citizenship */}
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-3">I am contributing as</label>
                      <div className="flex gap-4">
                        {['indian', 'foreign'].map((type) => (
                          <button
                            ...
                            className={`flex-1 py-3 px-4 rounded-xl border-2 text-sm font-bold transition-all flex items-center justify-center gap-2 ${
                              citizenType === type 
                                ? 'border-teal-600 bg-teal-50 text-teal-800' 
                                : 'border-gray-200 text-gray-500 hover:border-gray-300'
                            }`}
                          >
                            {type === 'indian' ? <span className="flex items-center gap-2"><Globe size={16}/> Indian Citizen</span> : 'Foreign Citizen'}
                            {citizenType === type && <CheckCircle size={16} />}
                          </button>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <InputField id="fname" label="First Name" value={firstName} onChange={(e) => setFirstName(e.target.value)} required />
                      <InputField id="lname" label="Last Name" value={lastName} onChange={(e) => setLastName(e.target.value)} required />
                      <InputField id="email" label="Email Address" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required />
                      <InputField id="mobile" label="Mobile Number" type="tel" value={mobile} onChange={(e) => setMobile(e.target.value)} required />
                      <InputField id="dob" label="Date of Birth" type="date" value={dob} onChange={(e) => setDob(e.target.value)} icon={Calendar} />
                      {citizenType === 'indian' && (
                        <InputField id="pan" label="PAN Number" value={pan} onChange={(e) => setPan(e.target.value)} required icon={CreditCard} />
                      )}
                    </div>
                    ...
                    <div className="border-t border-gray-100 pt-6">
                      ...
                      <div className="space-y-6">
                        <InputField id="address" label="Street Address" value={address} onChange={(e) => setAddress(e.target.value)} required />
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <InputField id="zip" label="Pincode" value={zip} onChange={(e) => setZip(e.target.value)} required />
                          <InputField id="city" label="City" value={city} onChange={(e) => setCity(e.target.value)} required />
                          <InputField id="province" label="State" value={province} onChange={(e) => setProvince(e.target.value)} required />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl text-xs text-gray-500 leading-relaxed">
                      By continuing, you agree to receive your 80G tax receipt and updates about our programs via email/WhatsApp. We value your privacy.
                    </div>
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.99 }}
                      type="submit"
                      disabled={!firstName || !lastName || !email || !mobile || !address}
                      className="w-full py-4 rounded-xl text-xl font-bold text-white shadow-xl shadow-teal-900/20 bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    >
                      Complete Donation
                    </motion.button>
                  </form>
...
const ILCPage = ({ onNavigate }) => (
  <section className="py-20 bg-white">
    <div className="max-w-4xl mx-auto px-4">
      <h1 className="text-4xl font-bold mb-6 text-center">Impact Leaders Circle (ILC)</h1>
      <p className="text-lg text-gray-600 mb-8 text-center">A premium membership for changemakers. Join the circle to drive sustainable impact.</p>
      <div className="bg-gray-100 p-8 rounded-xl">
        <h3 className="font-bold mb-4 text-xl text-center">Membership Registration Form</h3>
        <form className="space-y-4">
          <input type="text" placeholder="Full Name *" className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-orange-500" />
          <input type="email" placeholder="Email *" className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-orange-500" />
          <input type="tel" placeholder="Phone Number *" className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-orange-500" />
          <select className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-orange-500">
            <option>Select Membership Type</option>
            <option>Individual</option>
            <option>Corporate</option>
          </select>
          <button className="w-full bg-orange-500 text-white px-6 py-3 rounded-full font-bold hover:bg-orange-600 transition">
            Submit Registration
          </button>
        </form>
      </div>
        ...
        {step === 1 && (
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            >
              ...
              <div className="p-8 lg:p-10 text-center lg:text-left flex flex-col justify-center">
                <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-4">
                  Transform Lives, Empower Communities
                </h1>
                <p className="text-lg text-white/90 max-w-3xl lg:max-w-none mx-auto mb-10">
                  Join us in building a compassionate world where every elderly person can thrive with dignity.
                </p>
                
                <div className="grid grid-cols-3 gap-4 border-t border-b border-white/30 py-4 max-w-xl lg:max-w-none mx-auto">
              ...
              <div className="p-4 lg:p-6 flex flex-col justify-center">
                <div className="bg-white p-6 sm:p-8 rounded-xl shadow-2xl border-4" style={{ borderColor: COLORS.PRIMARY_DARK }}>
                  <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Sabri Helpage Donation</h2>
                  ...
                  <form className="space-y-5">
                    ...
                    {finalAmount <= 0 && <p className="text-red-500 text-sm">Please select or enter an amount.</p>}

                    <div>
                      <label htmlFor="support-category" className="block text-sm font-semibold text-gray-700 mb-2">I offer my support for</label>
                      <select
                        id="support-category"
                        value={supportCategory}
                        onChange={(e) => setSupportCategory(e.target.value)}
                        className="w-full p-3 rounded-xl bg-white text-gray-800 border-2 border-gray-300 focus:outline-none focus:ring-2"
                        style={{ '--tw-ring-color': COLORS.PRIMARY_DARK }}
                      >
                    ...
                    <div className="pt-2">
                      <button 
                        type="button"
                        className="w-full py-3 rounded-xl text-lg font-bold text-gray-800 bg-gray-100 hover:bg-gray-200 transition duration-300 shadow-md border-2 border-transparent hover:border-gray-300"
                      >
                        <span className="text-sm font-medium block mb-1 text-gray-500">For Regular Donors</span>
                        Login
                      </button>
                    </div>
                    ...
                    <div className="flex justify-between gap-4 pt-3">
                      <button
                        type="button"
                        onClick={() => setIsRecurring(false)}
                        className={`flex-1 py-2 rounded-lg text-xs font-semibold transition duration-200 border ${
                          !isRecurring ? 'bg-orange-500 text-white shadow-md border-orange-500' : 'bg-gray-100 text-gray-700 border-gray-300'
                        }`}
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        onClick={handleNext}
                        disabled={finalAmount <= 0}
                        className="w-full py-3 rounded-xl text-xl font-bold text-white transition duration-300 shadow-xl disabled:bg-gray-400"
                        style={{ backgroundColor: COLORS.PRIMARY_DARK }}
                      >
                        Next
                      </button>
