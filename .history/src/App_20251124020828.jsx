        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="flex flex-col h-full">
              <div 
                className="p-6 md:p-8 rounded-2xl shadow-xl h-full flex flex-col transition-transform duration-500 hover:scale-[1.01]" 
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mt-auto">
                  {[
                    ...
                    <div 
                      key={idx} 
                      className="p-4 rounded-xl text-center border border-white/10 transition-all duration-300 hover:bg-white/10 hover:-translate-y-1" 
                      style={{ backgroundColor: COLORS.PRIMARY_DARK }}
                    >
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Video Container - Uses aspect-video for perfect 16:9 fit */}
              <div className="relative w-full shadow-2xl rounded-2xl overflow-hidden aspect-video bg-black group">
                <YoutubeEmbed videoId={YOUTUBE_VIDEO_ID} title="Sabri Helpage Story" />
              </div>

              {/* The "Cool" Existing Button - Placed below video as a CTA */}
              <a 
                href="https://www.youtube.com/@YourChannel" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-between p-4 rounded-xl bg-gray-50 border-2 border-transparent hover:border-red-100 hover:bg-white shadow-sm hover:shadow-lg transition-all duration-300 group cursor-pointer"
              >
                <div className="flex items-center gap-4">
                  {/* YouTube Icon Container */}
                  <div className="w-12 h-12 flex items-center justify-center bg-white rounded-full shadow-sm group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Watch More</span>
                    <span className="text-lg font-bold text-gray-900 group-hover:text-red-600 transition-colors">Visit Youtube Channel</span>
                  </div>
                </div>

                {/* Arrow Icon */}
                <svg className="w-5 h-5 text-gray-400 group-hover:text-red-600 group-hover:translate-x-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
