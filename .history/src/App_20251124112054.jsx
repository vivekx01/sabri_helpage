...
const IMAGE_URLS = {
  ...
  WHAT_WE_STAND_FOR_1: 'happy-children.jpg',
  WHAT_WE_STAND_FOR_2: 'KidsLearning.jpg',
  WHAT_WE_STAND_FOR_3: 'communitySupport.jpg',
...
const ContactPage = () => {
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      {/* Hero Section - Matching the dark header style */}
      <div className="bg-slate-900 text-white pt-20 pb-32 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
            ...
            <div className="absolute left-0 bottom-0 w-64 h-64 bg-orange-600 rounded-full blur-3xl transform -translate-x-1/2 translate-y-1/2"></div>
        </div>
      ...
      {/* Orange Banner - Matches the "Milestones" section from image */}
      <div className="bg-orange-500 py-12 -mt-10 relative z-10 shadow-lg mx-4 md:mx-auto max-w-6xl rounded-2xl flex flex-col md:flex-row items-center justify-between px-8 md:px-16 overflow-hidden">
        <div className="relative z-10 text-center md:text-left mb-6 md:mb-0">
            <h2 className="text-3xl font-bold text-white mb-2">Do you have a Query?</h2>
            <p className="text-orange-100">Reach out to our support team anytime.</p>
        </div>
        ...
        {/* Decorative circle */}
        <div className="absolute -right-10 -bottom-20 w-48 h-48 bg-orange-400 rounded-full opacity-50"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Contact Form Section - Left Side (2/3 width) */}
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    rows="5" 
                    className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all resize-none"
                  ></textarea>
                </div>

                <div className="pt-2">
                  <button className="bg-orange-500 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-orange-600 transition duration-300 shadow-lg hover:shadow-orange-500/30 flex items-center justify-center gap-2 w-full md:w-auto">
          ...
          {/* Contact Info Cards - Right Side (1/3 width) - Stacked */}
          <div className="space-y-6">
            
            {/* Address Card */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-orange-500 hover:shadow-xl transition duration-300 group">
              <div className="bg-orange-50 w-14 h-14 rounded-full flex items-center justify-center mb-4 group-hover:bg-orange-500 transition-colors duration-300">
              ...
              <a href="#" className="inline-flex items-center text-sm font-bold text-orange-600 hover:text-orange-700">
                Open in Maps <ArrowRight className="w-4 h-4 ml-1" />
              </a>
            </div>

            {/* Email Card */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-slate-800 hover:shadow-xl transition duration-300 group">
              <div className="bg-slate-100 w-14 h-14 rounded-full flex items-center justify-center mb-4 group-hover:bg-slate-800 transition-colors duration-300">
                <Mail className="w-6 h-6 text-slate-800 group-hover:text-white transition-colors" />
              </div>
              <h4 className="font-bold text-xl text-gray-900 mb-2">Email Us</h4>
              <p className="text-gray-600 mb-4">info@sabrihelpage.org</p>
              <a href="mailto:info@sabrihelpage.org" className="inline-flex items-center text-sm font-bold text-slate-800 hover:text-slate-900">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-orange-500 hover:shadow-xl transition duration-300 group">
              ...
              <div className="space-y-1">
                <p className="text-gray-600 font-medium">+91 9874021457</p>
                <p className="text-gray-500 text-sm">033 4601 3886</p>
              </div>
              <div className="mt-4">
                 <a href="tel:+919874021457" className="inline-flex items-center text-sm font-bold text-orange-600 hover:text-orange-700">
      ...
      <div className="bg-slate-900 py-8 border-t border-slate-800">
         <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
            <div>
                 <h4 className="text-white font-bold text-lg">Make a difference today</h4>
                 <p className="text-slate-400 text-sm">Your contribution can change a life forever.</p>
            </div>
            <button className="mt-4 md:mt-0 bg-white text-slate-900 px-6 py-2 rounded-full font-bold text-sm hover:bg-gray-100 transition flex items-center">
                Donate Now <Heart className="w-4 h-4 ml-2 text-red-500 fill-current" />
            </button>
         </div>
      </div>
...
const OurCausesLandingPage = () => (
  <div className="min-h-screen bg-[#FFF9F5] font-sans text-slate-800">
    {/* Minimal Header */}
    <div className="bg-white border-b border-[#FFE4D6] py-6 px-6 sticky top-0 z-50">
      <div className="max-w-4xl mx-auto flex justify-between items-center">
        <div className="text-2xl font-bold text-[#FF7F50] tracking-tight">
          HOPE FOUNDATION
        </div>
        <button className="bg-[#FF7F50] text-white px-6 py-2 rounded-full font-medium hover:bg-[#E67347] transition-colors shadow-sm">
          Donate Now
        </button>
      </div>
    </div>
    ...
    <div className="max-w-4xl mx-auto px-6 py-24">
      <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-8 leading-tight">
        We don't just support causes. <br />
        <span className="text-[#FF7F50]">We build futures.</span>
      </h1>
      
      <div className="prose prose-lg text-slate-600 leading-relaxed">
        <p className="mb-6 text-xl">
          Across the diverse landscapes of India, the gap between potential and opportunity remains the greatest challenge of our time. While talent is universal, access to resources is not.
        </p>
        <p className="mb-6">
          Our mission goes beyond temporary relief. We are deeply invested in long-term systemic change. By identifying the root causes of poverty, exclusion, and stagnation, we design interventions that empower communities to lift themselves up. 
        </p>
        <p>
          From the remote tribal belts of Eastern India to the urban slums of the metropolises, our initiatives are creating ripples of change that will be felt for generations. Read on to understand the specific battles we are fighting today.
        </p>
      </div>
      
      <div className="h-px w-full bg-[#FF7F50] opacity-30 my-16"></div>
    </div>

    {/* Core Focus Areas - Detailed List */}
    <div className="max-w-4xl mx-auto px-6 pb-20">
      <h2 className="text-3xl font-bold text-slate-900 mb-2">Core Areas of Intervention</h2>
      <p className="text-slate-500 mb-12">Where your support goes and why it matters.</p>

      <div className="space-y-12">
        {/* Cause 1 */}
        <div className="bg-white p-8 rounded-xl border-l-4 border-[#FF7F50] shadow-sm">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">Grassroots Education & Digital Literacy</h3>
          <p className="text-slate-600 mb-4 leading-relaxed">
            The traditional education system often fails those on the margins. We aren't just building classrooms; we are bridging the digital divide. Our "Smart Village" initiative equips rural learning centers with tablets and internet access, ensuring a child in a remote hamlet has access to the same information as a child in a city.
          </p>
          <p className="text-slate-600 leading-relaxed">
            <strong>Current Impact:</strong> Over 1,200 students are currently enrolled in our after-school remedial programs, with a 94% retention rate in secondary school transitions.
          </p>
        </div>

        {/* Cause 2 */}
        <div className="bg-white p-8 rounded-xl border-l-4 border-[#E67347] shadow-sm">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">Healthcare on Wheels</h3>
          <p className="text-slate-600 mb-4 leading-relaxed">
            For many elderly citizens and pregnant women in rural clusters, the nearest hospital is often 50 kilometers away. We bring the hospital to the doorstep. Our Mobile Medical Units (MMUs) are equipped with diagnostic tools, essential medicines, and a qualified doctor on board.
          </p>
          <p className="text-slate-600 leading-relaxed">
            <strong>Current Impact:</strong> Our fleet of 5 vans conducts over 200 consultations weekly, significantly reducing maternal mortality rates in our target districts.
          </p>
        </div>

        {/* Cause 3 */}
        <div className="bg-white p-8 rounded-xl border-l-4 border-[#FF7F50] shadow-sm">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">Sustainable Livelihoods for Women</h3>
          <p className="text-slate-600 mb-4 leading-relaxed">
            Financial independence is the strongest defense against social oppression. We organize women into Self-Help Groups (SHGs) and provide capital and training for micro-enterprises—ranging from organic farming co-operatives to artisan handicraft units.
          </p>
          <p className="text-slate-600 leading-relaxed">
            <strong>Current Impact:</strong> We have facilitated ₹1.5 Crores in micro-loans, helping 450 women start businesses that now sustain their entire families.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white py-20 border-t border-[#FFE4D6]">
      <div className="max-w-4xl mx-auto px-6">
        <div className="mb-12">
          <span className="text-[#FF7F50] font-bold tracking-wider uppercase text-sm">Urgent Funding Needed</span>
          <h2 className="text-3xl font-bold text-slate-900 mt-2">Active Campaigns</h2>
        </div>

        <div className="grid grid-cols-1 gap-8">
          {[
            {
              title: "Project Udaan: Vocational Training",
              desc: "Unemployment among rural youth is skyrocketing. Project Udaan provides 6-month intensive training in electrical repair, plumbing, and mobile hardware repair, guaranteeing job placement upon completion.",
              target: "₹5,00,000",
              raised: "₹3,25,000"
            },
            {
              title: "Clean Water for Bundelkhand",
              desc: "Drought situations are forcing women to walk 4 hours daily for water. We are building 3 massive rainwater harvesting structures to recharge the groundwater table before the next summer hits.",
              target: "₹8,00,000",
              raised: "₹1,50,000"
            }
          ].map((campaign, idx) => (
            <div key={idx} className="flex flex-col md:flex-row gap-8 items-start p-6 bg-[#FFF9F5] rounded-lg border border-[#FFE4D6]">
              <div className="flex-1">
                <h3 className="text-xl font-bold text-slate-800 mb-3">{campaign.title}</h3>
                <p className="text-slate-600 mb-4">{campaign.desc}</p>
                <div className="flex gap-4 text-sm font-medium text-slate-500">
                  <span>Goal: <span className="text-slate-900">{campaign.target}</span></span>
                  <span>•</span>
                  <span>Raised: <span className="text-[#FF7F50]">{campaign.raised}</span></span>
                </div>
              </div>
              <button className="w-full md:w-auto whitespace-nowrap bg-slate-900 text-white px-6 py-3 rounded-lg hover:bg-slate-800 transition-colors">
    ...
    {/* Footer Statement */}
    <div className="bg-[#FF7F50] text-white py-16 px-6 text-center">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-3xl font-bold mb-6">Be the catalyst for change.</h2>
        <p className="text-lg text-[#FFE4D6] mb-8 leading-relaxed">
          Every rupee contributed goes directly to the field. We maintain 100% transparency with our accounts and provide quarterly impact reports to all our donors.
        </p>
        <button className="bg-white text-[#FF7F50] text-lg font-bold px-10 py-4 rounded-lg hover:bg-[#FFE4D6] transition-colors shadow-lg">
          Make a Contribution
        </button>
      </div>
    </div>
