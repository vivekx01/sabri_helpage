...
const ContactPage = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-[#FFF7ED] min-h-screen pb-20 font-sans selection:bg-orange-100 relative">
      ...
      <div className="pt-24 pb-12 text-center px-4">
        <p className="text-[#C2410C] font-bold mb-3 uppercase tracking-widest text-xs">
        ...
        <p className="text-gray-500 max-w-xl mx-auto text-lg">
          Whether you have a question about our programs, want to volunteer, or just want to say hello, we are here to answer.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* Address */}
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition-shadow group">
              <div className="w-12 h-12 bg-[#FFF7ED] rounded-full flex items-center justify-center mb-4 group-hover:bg-[#F97316] transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#F97316] group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <h4 className="font-bold text-gray-900 text-lg mb-2">Visit Us</h4>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">
                7 B, Mysore Road,<br />
                Rashbehari Avenue,<br />
                Kolkata - 700026
              </p>
              <a href="#" className="text-[#C2410C] text-sm font-bold hover:underline inline-flex items-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition-shadow group">
              ...
              <h4 className="font-bold text-gray-900 text-lg mb-4">Contact Info</h4>
              
              <div className="space-y-3">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider font-bold">Email</p>
                  <a href="mailto:info@sabrihelpage.org" className="text-gray-700 hover:text-[#F97316] transition-colors block">info@sabrihelpage.org</a>
                </div>
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider font-bold">Mobile</p>
                  <a href="tel:+919874021457" className="text-gray-700 hover:text-[#F97316] transition-colors block">+91 9874021457</a>
                </div>
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider font-bold">Telephone</p>
                  <a href="tel:03346013886" className="text-gray-700 hover:text-[#F97316] transition-colors block">033 4601 3886</a>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl border border-orange-100 p-8 md:p-10 h-full relative overflow-hidden">
              {/* Decorative gradient blob */}
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-orange-50 rounded-full blur-3xl opacity-60 pointer-events-none"></div>
              ...
              <div className="space-y-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full p-4 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F97316]/20 focus:border-[#F97316] transition-all text-gray-800 placeholder-gray-400"
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="6"
                    className="w-full p-4 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F97316]/20 focus:border-[#F97316] transition-all text-gray-800 placeholder-gray-400 resize-none"
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full md:w-auto bg-[#C2410C] text-white px-12 py-4 rounded-lg font-bold text-base hover:bg-[#A84920] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 duration-200 flex items-center justify-center gap-2"
                  >
      ...
      <div className="h-2 bg-gradient-to-r from-[#C2410C] to-[#F97316] fixed bottom-0 w-full"></div>
    </div>
  );
};
