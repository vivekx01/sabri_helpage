...
export const COLORS = {
  ...
  PRIMARY: '#B8774D',           // Main brand color (terracotta/brown-orange from logo)
  PRIMARY_DARK: '#8B5A38',      // Darker shade for headers and emphasis
  PRIMARY_LIGHT: '#D4A079',     // Lighter shade for backgrounds and hover states
  PRIMARY_PALE: '#F5EDE6',      // Very light shade for subtle backgrounds
  
  // Accent colors
  ACCENT_ORANGE: '#E89B6C',     // Complementary orange for CTAs
  ACCENT_WARM: '#C68A5E',       // Warm accent for highlights
  
  // Neutral colors
  BG_LIGHT_GRAY: '#f7f7f7',
  TEXT_DARK: '#2D1810',         // Dark brown for text
