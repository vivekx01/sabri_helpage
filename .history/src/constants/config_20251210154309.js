...
export const COLORS = {
  // Primary brand color
  PRIMARY: '#b13c30',           // Main brand color
  PRIMARY_DARK: '#b13c30',      // Use same for dark
  PRIMARY_LIGHT: '#b13c30',     // Use same for light
  PRIMARY_PALE: '#b13c30',      // Use same for pale

  // Accent colors (all same)
  ACCENT_ORANGE: '#b13c30',
  ACCENT_WARM: '#b13c30',

  // Neutral colors (keep for readability)
