      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 overflow-y-auto">
          <div className="bg-white w-full max-w-4xl rounded-xl shadow-2xl my-8 flex flex-col max-h-[90vh]" style={{ backgroundColor: '#FFF8F0' }}>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <input type="text" className="w-full p-3 bg-white border border-[#FFE4D6] rounded focus:ring-2 focus:ring-[#FF7F50] outline-none" placeholder="Enter full legal name" />
                  </div>

                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Type of Organisation</label>
                    <div className="flex gap-6 p-3 bg-white border border-[#FFE4D6] rounded">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="orgType" className="accent-[#FF7F50] w-4 h-4" />
                  ...
                  <div>
                    ...
                    <input type="text" className="w-full p-3 bg-white border border-[#FFE4D6] rounded focus:ring-2 focus:ring-[#FF7F50] outline-none" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Year of Establishment</label>
                    <input type="number" className="w-full p-3 bg-white border border-[#FFE4D6] rounded focus:ring-2 focus:ring-[#FF7F50] outline-none" />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea rows="3" className="w-full p-3 bg-white border border-[#FFE4D6] rounded focus:ring-2 focus:ring-[#FF7F50] outline-none"></textarea>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="tel" className="w-full p-3 bg-white border border-[#FFE4D6] rounded focus:ring-2 focus:ring-[#FF7F50] outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                    <input type="email" className="w-full p-3 bg-white border border-[#FFE4D6] rounded focus:ring-2 focus:ring-[#FF7F50] outline-none" />
                  </div>
                </div>
              </section>
            ...
            {/* Footer */}
            <div className="p-6 border-t border-[#FFE4D6] bg-white rounded-b-xl flex justify-end gap-4" style={{ backgroundColor: '#FFF8F0' }}>
              <button 
                onClick={toggleModal}
              ...
              <button className="px-8 py-3 text-white font-bold rounded-lg shadow-md transition-transform active:scale-95 bg-[#FF7F50]">
                Submit Registration
              </button>
            </div>
          </div>
