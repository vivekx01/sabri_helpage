...
// Removed useConfig, use static config or props as needed
import { sanitizeText, sanitizeList } from '../utils/sanitize';

const ElderlyCarePage = ({ onNavigate }) => {
  const config = { causes: { 'elderly-care': { title: 'Elderly Care', subtitle: 'Dignity and support for seniors', bannerImage: IMAGE_URLS.ELDERLY_CARE } } }; // Static config for demonstration
  const cause = config?.causes?.['elderly-care'] || null;
