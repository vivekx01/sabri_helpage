...
const MentalHealthPage = ({ onNavigate }) => {
  // Static fallback content for Mental Health page
  const content = {
    title: 'Mental Health',
    ...
    contentBlocks: [
      ...
      { type: 'paragraph', text: 'Mental health is just as important as physical health. At Sabri Helpage, we work to raise awareness, provide support, and create safe spaces for open conversations about emotional well-being.' },
      { type: 'list', text: 'Key Focus Areas:', items: [
        'Awareness and education in communities',
        'Support programs for college students',
        'Building networks for emotional support',
      ]},
    ]
  };
