          ...
          <div className="space-y-6">
            ...
            <div className="text-center pt-2">
              <button
                ...
                className="bg-[#FF7A42] text-white px-10 py-4 rounded-lg font-bold text-base hover:bg-[#E86830] transition shadow-lg hover:shadow-xl transform hover:scale-105 duration-200"
              >
                Send Message ✉
              </button>
            </div>
