...
const ElderlyCarePage = ({ onNavigate }) => {
  ...
  return (
    <section className="py-0 bg-white">
      <PageHeader title="Elderly Care" subtitle="Dignity and support for seniors" />
      <div className="py-20">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-xl text-gray-700 mb-8 leading-relaxed font-semibold" style={{ color: COLORS.ACCENT_ORANGE }}>
