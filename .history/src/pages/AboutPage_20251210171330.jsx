  ...
  return (
    <section className="py-16 md:py-24 bg-[#FFF8F0]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {founders.map((founder, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition duration-200">
                ...
                <p className="text-sm font-semibold text-[#FF7A42] mb-4">{founder.role}</p>
        ...
        {/* Statistics */}
        <div className="bg-gradient-to-r from-[#FF7A42] to-[#FF9500] text-white rounded-xl p-8 md:p-12">
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              style={{ borderColor: '#FF7A42', color: '#FF7A42' }}
            >
              Become SSIC Member
            </button>
          </div>
