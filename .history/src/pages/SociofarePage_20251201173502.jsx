...
const SociofarePage = () => {
  ...
  <div className="min-h-screen bg-white">
    <TopBar title={getText('sociofareHeader','The SocioFare Awards')} />

    {/* Hero Section */}
    <div className="text-white py-20 px-6" style={{ backgroundColor: COLORS.PRIMARY }}>
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6">{getText('sociofareTitle','The SocioFare Awards')}</h1>
        <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed" style={{ color: COLORS.PRIMARY_PALE }}>
    ...
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      {/* CTA Section */}
      <div className="text-center mt-16 rounded-2xl p-12 text-white" style={{ backgroundColor: COLORS.PRIMARY }}>
