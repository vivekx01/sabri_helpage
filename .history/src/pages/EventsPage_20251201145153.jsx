  ...
  <div className="min-h-screen bg-white">
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      <div className="text-center mb-16">
        ...
        <div className="h-1 w-24 mx-auto mt-6" style={{ backgroundColor: COLORS.PRIMARY }}></div>
      </div>
            ...
            <div className="md:flex">
              ...
              <div className="md:w-4/5 p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="px-6 py-3 text-white font-semibold rounded-lg transition-colors flex items-center gap-2 justify-center" style={{ backgroundColor: COLORS.PRIMARY }}>
                    <i className="fas fa-calendar-plus"></i>
                    Register Now
                  </button>
                  <button className="px-6 py-3 font-semibold rounded-lg transition-colors flex items-center gap-2 justify-center border" style={{ borderColor: COLORS.PRIMARY, color: COLORS.PRIMARY, backgroundColor: 'transparent' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white rounded-lg border p-6 hover:shadow-lg transition-shadow" style={{ borderColor: COLORS.PRIMARY_PALE }}>
              ...
              <button className="w-full py-2 font-medium rounded-lg transition-colors border" style={{ borderColor: COLORS.PRIMARY, color: COLORS.PRIMARY }}>
                View Photos
              </button>
            </div>
          ))}
      ...
      <div className="mt-16 rounded-xl p-8 text-center" style={{ backgroundColor: COLORS.PRIMARY_PALE }}>
        ...
        <div className="max-w-md mx-auto flex gap-4">
          ...
          />
          <button className="px-6 py-3 text-white font-semibold rounded-lg transition-colors" style={{ backgroundColor: COLORS.PRIMARY }}>
            Subscribe
          </button>
        </div>
      </div>
