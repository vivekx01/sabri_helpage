      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-8 lg:px-12 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center mb-12">
          <div className="bg-white rounded-2xl shadow-xl px-8 py-10 flex flex-col items-center border border-[#FFE4D6]">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-3 text-center">Our Causes</h1>
            <p className="text-lg text-gray-600 text-center">Discover the areas where we're creating meaningful change</p>
          </div>
        </div>
