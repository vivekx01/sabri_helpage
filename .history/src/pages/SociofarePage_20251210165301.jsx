  ...
  <section className="py-0 bg-white">
    ...
    <div className="py-16 md:py-20">
      <div className="max-w-5xl mx-auto px-6">
        ...
        {/* Events Section */}
        <div className="rounded-2xl p-8 mb-12 border" style={{ backgroundColor: '#f9e6e4', borderColor: '#f9e6e4' }}>
          <h3 className="text-3xl font-bold text-center" style={{ color: COLORS.PRIMARY }}>Events Calendar</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="rounded-xl p-6 shadow-sm border hover:shadow-md transition-shadow" style={{ backgroundColor: '#f9e6e4', borderColor: COLORS.PRIMARY }}>
