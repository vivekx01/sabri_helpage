                ...
                <div className="max-w-5xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {GALLERY_IMAGES.map((img, index) => (
                            <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden transition duration-300 hover:shadow-2xl hover:scale-[1.02] flex flex-col">
                                <img
                                    src={img.src}
                                    alt={img.text}
                                ...
                                />
                                <div className="p-4 text-center text-base font-medium text-gray-700 flex-1 flex items-center justify-center">
                                    {img.text}
                                </div>
                            </div>
                        ))}
