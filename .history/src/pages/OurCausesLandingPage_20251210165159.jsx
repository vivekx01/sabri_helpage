  ...
  <div className="min-h-screen bg-white text-gray-800">
    ...
    <PageSection bg="white">
      <div className="max-w-5xl mx-auto">
        <div className="rounded-2xl shadow-lg p-8 md:p-10 text-center" style={{ backgroundColor: '#f9e6e4' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
            <div className="bg-white p-6 rounded-xl border shadow-sm" style={{ borderColor: COLORS.PRIMARY_PALE }}>
              ...
              <p className="text-sm text-gray-600">
                Menstrual hygiene kits and health education for adolescent girls.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border shadow-sm" style={{ borderColor: COLORS.PRIMARY_PALE }}>
              <h4 className="font-bold mb-2" style={{ color: COLORS.PRIMARY_DARK }}>
              ...
              <p className="text-sm text-gray-600">
                Beyond literacy, we provide skills to secure safe, dignified employment.
              </p>
            </div>
          </div>
