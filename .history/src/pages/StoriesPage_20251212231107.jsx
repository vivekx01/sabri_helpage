  ...
  const stories = [
    {
      ...
      category: 'Mental Health',
          <section className="py-0 md:py-24 bg-[#FFF8F0]">
            <PageHeader title="Stories of Change" subtitle="Real stories from the people and communities we serve." />
  ...
  return (
    <section className="py-16 md:py-24 bg-[#FFF8F0]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div key={story.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm font-semibold px-3 py-1 rounded-full bg-[#FFF5F0]" style={{ color: '#FF7A42' }}>
                    {story.category}
                  </span>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  <button className="transition" style={{ color: '#FF7A42' }}>
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-[#FF7A42] to-[#FF9500] text-white rounded-xl p-8 md:p-12 text-center">
