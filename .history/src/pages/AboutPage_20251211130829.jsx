  ...
  return (
    <section className="py-16 md:py-24 bg-[#FFF8F0] flex justify-center">
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-8 lg:px-12 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center mb-12">
          <div className="bg-white rounded-2xl shadow-xl px-8 py-10 flex flex-col items-center border border-[#FFE4D6]">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-3 text-center">About</h1>
            <p className="text-lg text-gray-600 text-center">Founding, purpose and governing body</p>
          </div>
        </div>

        {/* Main Content Box */}
        <div className="w-full flex flex-col gap-10 text-gray-800">
          <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center border border-[#FFE4D6]">
            <h2 className="text-2xl font-bold mb-6" style={{ color: COLORS.PRIMARY_DARK }}>About</h2>
            <div className="space-y-5 text-lg leading-relaxed text-center">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center border border-[#FFE4D6]">
            <h2 className="text-2xl font-bold mb-6" style={{ color: COLORS.PRIMARY_DARK }}>Governing Body</h2>
            <div className="space-y-10 w-full">
              {/* Fallback section remains if not provided by admin */}
              <div className="text-center">
                <h3 className="text-xl font-bold mb-2" style={{ color: COLORS.PRIMARY }}>Aarti BR Singh</h3>
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold mb-2" style={{ color: COLORS.PRIMARY }}>Yash Guptaa</h3>
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold mb-2" style={{ color: COLORS.PRIMARY }}>Prerna Guptaa</h3>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 -mt-10">
        <div className="space-y-10" style={{ color: '#b13c30' }}>
