...
const DonatePage = ({ onNavigate = () => {} }) => {
  ...
  // Static config (no API)
  const texts = {
    donateTitle: 'Make a Difference',
    donateSubtitle: 'Your contribution helps us create lasting change in communities',
    donateEyebrow: 'Support Our Mission',
    donateHeroTitle: 'Transform Lives, Empower Communities',
    donateHeroBody: 'Join us in building a compassionate world where every elderly person can thrive with dignity.',
    donateFormTitle: 'Sabri Helpage Donation',
    donateSupportLabel: 'I offer my support for',
    donateSupportOpt1: 'Elderly Care',
    donateSupportOpt2: 'Education',
    donateSupportOpt3: 'Mental Health',
    donateSupportOpt4: 'General Fund',
    donateOneTime: 'One-time',
    donateRecurring: 'Monthly Recurring',
    donateNext: 'Next',
    donateTaxNote: 'All Donations to Sabri Helpage are tax exempted.',
    donateBack: 'Back to Amount',
    donatePayLabel: 'Pay',
    donatePaySuffix: 'Now',
    donateSummaryTitle: 'Donation Summary',
    donateSummaryBody: 'We ensure that your donation reaches those who need it most, with complete transparency and accountability.'
  };
  const getText = (key, fallback) => texts[key] || fallback;
            ...
            <div className="py-10 sm:py-16 px-4 sm:px-10 lg:px-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <FocusAreaCard
                  ...
                  iconColor={{ fg: COLORS.PRIMARY, bg: COLORS.PRIMARY_PALE }}
                />
                <FocusAreaCard
                  icon={Users}
                  title="Elderly Care"
                  subtitle="Dignity and support for senior citizens."
                  iconColor={{ fg: COLORS.PRIMARY_DARK, bg: COLORS.PRIMARY_PALE }}
                />
                <FocusAreaCard
                  icon={BookOpen}
                  title="Girl Child Education"
                  subtitle="Education and girl child empowerment."
                  iconColor={{ fg: COLORS.PRIMARY_LIGHT, bg: COLORS.PRIMARY_PALE }}
                />
              </div>
            </div>
