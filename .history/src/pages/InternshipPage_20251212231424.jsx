      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          ...
          <div className="flex max-w-md">
            <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="you@example.com" className="flex-1 px-4 py-2 border rounded-l-lg focus:ring-2" style={{ borderColor: COLORS.PRIMARY_PALE, '--tw-ring-color': COLORS.PRIMARY }} />
            <button onClick={() => { if (!email) return alert('Enter email'); alert('Use the individual Apply buttons on roles.'); }} className="px-4 py-2 text-white rounded-r-lg" style={{ backgroundColor: COLORS.PRIMARY }}>Submit</button>
          </div>
