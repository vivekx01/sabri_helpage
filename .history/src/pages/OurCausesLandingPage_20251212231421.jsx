          ...
          {causes.map((cause, index) => (
            <div key={index} className="bg-white rounded-2xl shadow-xl border border-[#FFE4D6] flex flex-col items-center p-8 transition duration-300 hover:shadow-2xl">
              ...
              <button
                ...
                className="inline-flex items-center space-x-2 font-semibold transition duration-200 px-5 py-2 rounded-full bg-[#F8F9FA] hover:bg-[#b4362c]/10 text-[#b4362c] border border-[#b4362c]"
              >
