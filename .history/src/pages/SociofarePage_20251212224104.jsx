...
const SociofarePage = () => {
  ...
  useEffect(() => {
    ...
    const fetchConfig = async () => {
      try {
        ...
        if (mounted) {
          // Don't show error to user, just use default content
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <Section>
        <Container>
          <div className="prose max-w-none text-gray-700 leading-relaxed mb-16 text-justify">
