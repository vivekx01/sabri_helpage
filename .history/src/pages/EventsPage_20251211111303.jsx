    ...
    <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white rounded-lg border p-6 hover:shadow-lg transition-shadow" style={{ borderColor: COLORS.PRIMARY_PALE }}>
              ...
              <button className="w-full px-4 py-2 bg-orange-500 text-white rounded-lg font-bold">View Photos</button>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-16 rounded-xl p-8 text-center" style={{ backgroundColor: COLORS.PRIMARY_PALE }}>
        ...
        <div className="max-w-md mx-auto flex gap-4">
          ...
          />
          <button className="px-6 py-3 bg-orange-500 text-white font-semibold rounded-lg">Subscribe</button>
        </div>
      </div>
      </div>
    {/* PageSection removed */}
