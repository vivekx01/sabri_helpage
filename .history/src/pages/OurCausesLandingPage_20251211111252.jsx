    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="rounded-2xl shadow-lg p-8 md:p-10 text-center" style={{ backgroundColor: COLORS.PRIMARY_PALE }}>
          <div className="mb-6 flex justify-center"><span className="px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-xs font-bold uppercase">Awareness</span></div>
          ...
          <button className="px-6 py-2 bg-orange-500 text-white rounded-full font-bold" onClick={() => onNavigate?.('mental-health')}>Read More</button>
        </div>
      </div>
