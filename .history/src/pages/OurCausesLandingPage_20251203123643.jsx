    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <PageSection bg="white">
        <div className="max-w-5xl mx-auto px-6">
          <div className="rounded-2xl shadow-lg p-8 md:p-10 text-center mb-12" style={{ backgroundColor: COLORS.PRIMARY_PALE }}>
      />
      ...
      <PageSection bg="white">
        <div className="max-w-5xl mx-auto">
            ...
            <ul className="space-y-3.5 md:space-y-4 mb-8 text-left max-w-xl mx-auto">
                'causeElderlyBody',
