  ...
  <div className="min-h-screen bg-white">
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="space-y-8">
        {events && events.length > 0 ? events.slice(0, 4).map((event) => (
              ...
              <div className="md:w-4/5 p-8">
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  {event.tags && event.tags.map((tag, idx) => (
                    <span key={idx} className="bg-[#FFF8F0] text-[#E67347] px-3 py-1 rounded-full text-sm">{tag}</span>
                  ))}
                  {(!event.tags || event.tags.length === 0) && (
                    <span className="bg-[#FFF8F0] text-[#E67347] px-3 py-1 rounded-full text-sm">Event</span>
                  )}
                </div>
