...
const DonatePage = ({ onNavigate = () => {} }) => {
  ...
  const alwaysShowFallback = !cfg || Object.keys(cfg).length === 0;

  if (alwaysShowFallback) {
    return (
      <div className="min-h-screen bg-white text-gray-800 p-8">
        <h1 className="text-3xl font-bold mb-4">Donate</h1>
        <p>Your support helps us provide dignity, care, and education to those in need.</p>
        <ul className="list-disc pl-6 mt-4">
          <li>Mental Health</li>
          <li>Elderly Care</li>
          <li>Girl Child Education</li>
        </ul>
        <p className="mt-4">To donate, please contact us at <a href="mailto:info@sabrihelpage.org" className="text-blue-600 underline">info@sabrihelpage.org</a>.</p>
      </div>
    );
  }
