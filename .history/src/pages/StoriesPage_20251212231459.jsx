  ...
  return (
    <section className="py-16 md:py-24 bg-[#FFF8F0]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div key={story.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm font-semibold px-3 py-1 rounded-full bg-[#FFF5F0]" style={{ color: COLORS.PRIMARY }}>
                    {story.category}
                  </span>
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-[#b4362c] to-[#b4362c] text-white rounded-xl p-8 md:p-12 text-center">
