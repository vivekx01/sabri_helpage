...
const SociofarePage = () => {
  ...
  useEffect(() => {
    ...
    api.getConfig().then((res) => {
      ...
      if (mounted) setCfg({
        texts: {
          sociofareCalendarTitle: 'Events Calendar',
          sociofareEventTitle: 'Award Ceremony',
          sociofareEventDesc: 'Celebrating community heroes and their impactful work',
          sociofareMissionTitle: 'Our Mission',
          sociofareMissionBody: 'The SocioFare is a movement dedicated to recognizing and celebrating selfless individuals who devote their lives to the service of others.',
          sociofareJoinTitle: 'Join Us',
          sociofareJoinBody: 'Be part of this celebration of real-life heroes who illuminate the path for others through their compassion and service.',
          sociofareCtaTitle: 'Nominate a Hero',
          sociofareCtaBody: 'Know someone making a difference? Nominate them for the SocioFare Awards and help us recognize their incredible work.'
        }
      });
    });
