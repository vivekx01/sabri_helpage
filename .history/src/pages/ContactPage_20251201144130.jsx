...
const ContactPage = ({ onNavigate }) => {
  const BackButton = ({ onClick }) => (
    <button
      onClick={onClick}
      className="flex items-center text-sm font-semibold mb-8 transition-all duration-300 hover:translate-x-[-4px] group"
  ...
  return (
    <div className="bg-[#FFF8F0] min-h-screen pb-20">
      <PageHero title="Contact Us" subtitle="Do you have a Query?" />
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-2xl transition duration-300 border-2 border-[#FFF8F0] group">
            <div className="bg-[#FFF5F0] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5 transition duration-300" style={{ backgroundColor: '#FFF5F0' }}>
              <svg className="w-8 h-8" style={{ color: COLORS.PRIMARY }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-2xl transition duration-300 border-2 border-[#FFF8F0] group">
            <div className="bg-[#FFF5F0] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5 transition duration-300" style={{ backgroundColor: '#FFF5F0' }}>
              <svg className="w-8 h-8" style={{ color: COLORS.PRIMARY }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            </div>
