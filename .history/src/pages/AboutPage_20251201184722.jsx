...
const AboutPage = () => {
  return (
    <section className="py-0 bg-white">
      <PageHeader title="About" subtitle="Founding, purpose and governing body" />
      <div className="max-w-5xl mx-auto px-6 pb-20">
        <div className="space-y-10 text-gray-800">
          <div className="bg-white rounded-2xl shadow-md p-8 md:p-10">
            <h2 className="text-3xl font-bold mb-6" style={{ color: COLORS.PRIMARY_DARK }}>About</h2>
            <div className="space-y-5 text-lg leading-relaxed">
              <p>Sabri Helpage was founded in 2013 and is based in Kolkata, India. Its simple goal is to bring dignity, care, and emotional support to communities that are often ignored. Over time, it has become a caring social project that focuses on three main areas: mental health, caring for the elderly, and educating girls.</p>
              <p>Sabri Helpage works at the grassroots level, helping families in need and villages that are hard to reach where there isn't much information or help. Sabri Helpage keeps making a difference by running counselling camps, programs for emotional well-being, help for seniors, and programs that promote education and empowerment for young girls.</p>
              <p>What started as a sincere effort has now become a dependable source of support for many. Sabri Helpage is dedicated to making society more knowledgeable, emotionally strong, and welcoming, one life at a time.</p>
            </div>
          </div>
