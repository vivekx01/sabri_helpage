...
const ElderlyCarePage = ({ onNavigate }) => {
  ...
  return (
    <section className="py-0 bg-white">
      <PageHeader title="Elderly Care" subtitle="Care, respect, and emotional security for every elder." />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        />
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6" style={{ display: 'none' }}>Elderly Care</h1>
