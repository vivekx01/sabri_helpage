  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800">
      ...
      <header className="border-b border-gray-200 bg-white">
        {/* Top slim bar */}
        <div className="bg-purple-900 text-white text-xs py-2 px-4 sm:px-8 flex justify-between items-center">
          <span className="tracking-wide">Sabri HelpAge | Groups</span>
          <div className="space-x-4 hidden sm:block">
            <span className="cursor-pointer hover:underline">Group Page</span>
        ...
        {/* Main Logo Bar */}
        <div className="py-6 px-4 sm:px-8 max-w-6xl mx-auto flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-serif text-slate-700">
              Sabri <span className="text-purple-900 font-bold">HelpAge</span>
            </h1>
            <div className="text-slate-500 text-lg mt-1 border-l-2 border-slate-300 pl-3 ml-1">
              Social Impact Club at Sabri | Home
            </div>
          </div>
          ...
          <nav className="hidden md:flex space-x-6 text-sm font-medium text-slate-600">
            ...
            <a href="#" className="hover:text-purple-900">Prospective Members</a>
            <a href="#" className="hover:text-purple-900">Alumni</a>
          </nav>
          <Menu className="md:hidden w-6 h-6 text-slate-600" />
        </div>
      </header>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/70 backdrop-blur-sm p-4 overflow-y-auto">
          ...
          {/* Modal Container */}
          <div className="bg-white w-full max-w-4xl rounded-xl shadow-2xl my-8 flex flex-col max-h-[90vh]">
            
            {/* Header */}
            <div className="flex justify-between items-center p-6 border-b border-gray-100 sticky top-0 bg-white z-10 rounded-t-xl">
              <div>
                <h2 className="text-2xl font-bold text-purple-900">SSIC Registration</h2>
                <p className="text-sm text-gray-500">Please fill out all details below to apply.</p>
              </div>
            ...
            <div className="overflow-y-auto p-8 space-y-10 custom-scrollbar">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <input type="text" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none" placeholder="Enter full legal name" />
                  </div>

                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Type of Organisation</label>
                    <div className="flex gap-6 p-3 bg-gray-50 border border-gray-200 rounded">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="orgType" className="accent-purple-600 w-4 h-4" />
                  ...
                  <div>
                    ...
                    <input type="text" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Year of Establishment</label>
                    <input type="number" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none" />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea rows="3" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none"></textarea>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="tel" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                    <input type="email" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none" />
                  </div>
                </div>
              </section>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                       <label className="border p-4 rounded flex items-center gap-3 cursor-pointer hover:border-purple-500 transition-colors">
                          <input type="radio" name="membership" className="w-5 h-5 accent-purple-600" />
                  ...
                  <div>
                    ...
                    <textarea rows="2" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none"></textarea>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    <label key={item} className="flex items-center gap-3 p-3 border rounded hover:bg-purple-50 cursor-pointer transition-colors">
                      <input type="checkbox" className="w-5 h-5 rounded text-purple-600 focus:ring-purple-500 border-gray-300" />
                      <span className="text-gray-700">{item}</span>
                    </label>
                  ))}
                  <div className="md:col-span-2 flex items-center gap-3 p-3 border rounded">
                     <input type="checkbox" className="w-5 h-5 rounded text-purple-600" />
                     <span className="text-gray-700 whitespace-nowrap">Other:</span>
                     <input type="text" className="w-full border-b border-gray-300 focus:border-purple-500 outline-none bg-transparent px-2" placeholder="Specify here..." />
                  </div>
                </div>
              </section>
              ...
              <section>
                <h3 className="font-bold text-lg uppercase tracking-wide text-purple-700 mb-2">E. Social Impact Activities</h3>
                ...
                <textarea rows="4" className="w-full p-3 bg-gray-50 border border-gray-200 rounded focus:ring-2 focus:ring-purple-500 outline-none" placeholder="Brief Summary..."></textarea>
              </section>
              ...
              {/* Section F: Documents */}
              <section>
                <h3 className="font-bold text-lg uppercase tracking-wide text-purple-700 mb-4">F. Documents to Attach</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <label key={doc} className="flex items-center justify-between p-4 border border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-purple-50 hover:border-purple-300 transition-colors group">
                       <div className="flex items-center gap-3">
                         <Upload className="w-5 h-5 text-gray-400 group-hover:text-purple-500" />
                         <span className="text-sm font-medium text-gray-600 group-hover:text-purple-700">{doc}</span>
                       </div>
            ...
            {/* Footer (Sticky) */}
            <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-xl flex justify-end gap-4">
              <button 
                onClick={toggleModal}
              ...
              <button className="px-8 py-3 bg-purple-700 text-white font-bold rounded-lg hover:bg-purple-800 shadow-md transition-transform active:scale-95">
                Submit Registration
              </button>
            </div>
