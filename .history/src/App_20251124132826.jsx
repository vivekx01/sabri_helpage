...
const ContactPage = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#F5F0E8] via-[#FFF9F4] to-[#F5F0E8] min-h-screen pb-20 relative">
      
      {/* --- CHANGED: BREADCRUMB NAVIGATION --- */}
      <div className="absolute top-6 left-4 md:left-8 z-30">
        <nav className="flex items-center space-x-2 bg-white/60 backdrop-blur-md px-4 py-2 rounded-full border border-white/50 shadow-sm">
          <button 
            onClick={() => onNavigate('home')} 
            className="flex items-center text-gray-500 hover:text-[#C75C2E] transition-colors text-sm font-medium group"
          >
          ...
          <span className="flex items-center text-[#C75C2E] font-semibold text-sm bg-[#C75C2E]/10 px-2 py-0.5 rounded-md">
            Contact Us
          </span>
        </nav>
      </div>
      ...
      <div className="pt-24 pb-10 text-center relative overflow-hidden">
        <div className="absolute top-10 left-10 w-20 h-20 bg-[#FF8C42] opacity-10 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute top-20 right-20 w-32 h-32 bg-[#C75C2E] opacity-10 rounded-full blur-3xl"></div>
        
        <div className="relative z-10 px-4">
            <p className="text-[#C75C2E] font-bold tracking-widest uppercase text-xs mb-3">We are here to help</p>
      ...
      <div className="max-w-6xl mx-auto px-4 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl border border-orange-100 shadow-lg hover:shadow-xl transition-shadow flex flex-col items-center text-center group">
            <div className="w-12 h-12 bg-orange-50 rounded-full flex items-center justify-center text-[#C75C2E] mb-3 group-hover:bg-[#C75C2E] group-hover:text-white transition-colors">
          ...
          <div className="bg-white p-6 rounded-2xl border border-orange-100 shadow-lg hover:shadow-xl transition-shadow flex flex-col items-center text-center group">
            ...
            <div className="text-sm text-gray-500 font-medium">Lives Touched</div>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-orange-100 shadow-lg hover:shadow-xl transition-shadow flex flex-col items-center text-center group">
            <div className="w-12 h-12 bg-orange-50 rounded-full flex items-center justify-center text-[#C75C2E] mb-3 group-hover:bg-[#C75C2E] group-hover:text-white transition-colors">
      ...
      <div className="bg-gradient-to-r from-[#A84920] via-[#C75C2E] to-[#FF8C42] py-16 relative overflow-hidden mb-24 shadow-2xl skew-y-1 transform origin-left">
        <div className="-skew-y-1 transform origin-left"> {/* Counter skew for content */}
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Have a <span className="text-[#FFF9F4] underline decoration-orange-300/50 underline-offset-4">Question?</span>
            </h2>
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-12 relative z-20 mb-24">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#FF8C42]/5 to-transparent rounded-bl-full pointer-events-none"></div>
          
          <div className="relative z-10">
            <div className="text-center mb-10">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#C75C2E] to-[#FF8C42] rounded-2xl mb-6 shadow-lg shadow-orange-200 transform rotate-3 hover:rotate-0 transition-transform">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full p-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#C75C2E]/20 focus:border-[#C75C2E] text-sm bg-gray-50 group-hover:bg-white transition-all duration-300"
                  />
                </div>
                <div className="relative group">
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Your Email</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div className="relative group">
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Your Message</label>
                <textarea
                  name="message"
                  ...
                  rows="6"
                  className="w-full p-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#C75C2E]/20 focus:border-[#C75C2E] text-sm bg-gray-50 group-hover:bg-white transition-all duration-300 resize-none"
                ></textarea>
              </div>
              ...
              <div className="text-center pt-4">
                <button
                  ...
                  className="bg-gradient-to-r from-[#C75C2E] to-[#FF8C42] text-white px-12 py-4 rounded-xl font-bold text-base hover:from-[#A84920] hover:to-[#E67E22] transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-orange-200 transform hover:-translate-y-1 inline-flex items-center gap-2"
                >
      ...
      <div className="max-w-6xl mx-auto px-4 mb-20">
        <div className="text-center mb-16">
          <span className="text-[#C75C2E] font-bold tracking-wider uppercase text-xs">Channels</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Address Card */}
          <div className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-orange-200 group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFF7ED] rounded-bl-full group-hover:scale-110 transition-transform duration-500"></div>
            <div className="relative z-10">
              <div className="w-14 h-14 bg-orange-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#C75C2E] transition-colors duration-300">
                <MapPin className="w-7 h-7 text-[#C75C2E] group-hover:text-white transition-colors" />
              </div>
              <h4 className="font-bold text-gray-900 mb-2 text-xl">Visit Our Office</h4>
              <p className="text-sm text-gray-500 mb-6">Drop by for a chat or to learn more about our work</p>
              <p className="text-gray-800 mb-8 leading-relaxed font-medium text-lg">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center text-sm text-[#C75C2E] font-bold hover:text-[#FF8C42] transition-colors group-hover:translate-x-2 transform duration-300"
              >
                <Globe className="w-5 h-5 mr-2" /> Get Directions
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6">
             {/* Email */}
            <div className="bg-white p-8 rounded-3xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 group flex items-center gap-6">
                <div className="w-12 h-12 bg-orange-50 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-[#C75C2E] transition-colors">
                    <Mail className="w-6 h-6 text-[#C75C2E] group-hover:text-white transition-colors" />
                </div>
                <div>
                    <h4 className="font-bold text-gray-900">Email Us</h4>
                    <a href="mailto:info@sabrihelpage.org" className="text-gray-600 hover:text-[#C75C2E] transition-colors block mt-1">info@sabrihelpage.org</a>
                </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 group flex items-center gap-6">
                <div className="w-12 h-12 bg-orange-50 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-[#C75C2E] transition-colors">
                    <Phone className="w-6 h-6 text-[#C75C2E] group-hover:text-white transition-colors" />
                </div>
                <div>
                    <h4 className="font-bold text-gray-900">Mobile</h4>
                    <a href="tel:+919874021457" className="text-gray-600 hover:text-[#C75C2E] transition-colors block mt-1">+91 9874021457</a>
                </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 group flex items-center gap-6">
                ...
                <div>
                    <h4 className="font-bold text-gray-900">Office Line</h4>
                    <a href="tel:03346013886" className="text-gray-600 hover:text-[#C75C2E] transition-colors block mt-1">033 4601 3886</a>
                </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-gradient-to-r from-[#8B5A2B] via-[#A84920] to-[#C75C2E] rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <button className="bg-white text-[#C75C2E] px-8 py-3.5 rounded-xl font-bold hover:bg-orange-50 transition shadow-lg">
                Learn More
              </button>
              <button className="bg-[#FF8C42] text-white px-8 py-3.5 rounded-xl font-bold hover:bg-[#E67E22] transition shadow-lg border border-[#FF8C42] hover:border-[#E67E22]">
                Volunteer
              </button>
            </div>
          </div>
