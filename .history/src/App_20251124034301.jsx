    ...
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold saffron-text mb-4">
            Welcome to Sabri Social Impact Club!
          </h2>
          <div className="h-1 w-24 saffron-bg mx-auto"></div>
        </div>

        {/* Body Text */}
        <div className="prose max-w-none text-gray-700 leading-relaxed text-justify mb-16">
          <p className="mb-4 text-lg">
            <span className="font-bold saffron-text">SSIC</span> is the vision of Sabri Helpage to create a caring and socially responsible community where businesses and nonprofits work together to make a difference in society that lasts.
          </p>
          <p className="text-lg">
        ...
        <div className="flex justify-center mb-16">
          <button 
            onClick={toggleModal}
            className="group relative px-8 py-4 saffron-bg text-white font-bold rounded-full shadow-lg hover:bg-orange-600 transition-all transform hover:-translate-y-1 flex items-center gap-3"
          >
      ...
      {/* Mission Banner */}
      <div className="w-full saffron-bg py-16 px-6 text-center shadow-inner relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-orange-200 mt-4 font-semibold tracking-wider uppercase text-sm">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <h3 className="text-3xl saffron-text mb-8 font-serif border-b pb-4">Our Mission</h3>
        ...
        <div className="space-y-6 text-gray-700">
          {[
            ...
            <div key={idx} className="flex gap-4 items-start">
               <span className="font-bold saffron-text text-xl">›</span>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 overflow-y-auto">
          <div className="bg-white w-full max-w-4xl rounded-xl shadow-2xl my-8 flex flex-col max-h-[90vh] saffron-light-bg">
            {/* Header */}
            <div className="flex justify-between items-center p-6 border-b border-orange-200 sticky top-0 bg-white z-10 rounded-t-xl saffron-light-bg">
              <div>
                <h2 className="text-2xl font-bold saffron-text">SSIC Registration</h2>
            ...
            <div className="overflow-y-auto p-8 space-y-10 custom-scrollbar">
              ...
              <section>
                <div className="flex items-center gap-2 mb-4 saffron-text">
              ...
              {/* (C: Membership Info, D: Focus Areas, E: Activities, F: Documents) */}
              
            </div>

            {/* Footer */}
            <div className="p-6 border-t border-orange-200 bg-white rounded-b-xl flex justify-end gap-4 saffron-light-bg">
              <button 
                onClick={toggleModal}
              ...
              <button className="px-8 py-3 text-white font-bold rounded-lg shadow-md transition-transform active:scale-95 saffron-bg">
                Submit Registration
              </button>
            </div>
          </div>
...
const SociofarePage = () => (
  <div className="min-h-screen bg-white">
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold saffron-text mb-6">The SocioFare Awards 2025</h1>
        <div className="h-1 w-32 saffron-bg mx-auto mb-8"></div>
      </div>
      ...
      <div className="bg-orange-50 rounded-xl p-8 mb-12">
        <h3 className="text-2xl font-bold saffron-text mb-6 text-center">2025 Events</h3>
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-lg p-4 shadow-md">
            <select className="w-full p-3 border border-orange-200 rounded focus:ring-2 focus:ring-orange-500 outline-none">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-orange-50 p-6 rounded-xl">
          <h3 className="text-xl font-bold saffron-text mb-4">Our Mission</h3>
        ...
        <div className="bg-orange-50 p-6 rounded-xl">
          <h3 className="text-xl font-bold saffron-text mb-4">Join Us</h3>
          <p className="text-gray-700">
...
// Expanded Causes Page Component
...
// Stories Page Component (Vertical Layout)
const StoriesPage = () => (
  <div className="min-h-screen bg-white">
    {/* Header */}
    <div className="saffron-bg text-white py-4 px-6">
    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold saffron-text mb-6">Our Stories</h1>
      ...
      <div className="space-y-12">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white rounded-xl shadow-lg overflow-hidden border border-orange-100 hover:shadow-xl transition-shadow">
            <div className="md:flex">
              <div className="md:w-1/3">
                <div className="h-64 md:h-full bg-orange-200 flex items-center justify-center">
                  <i className="fas fa-book-open text-5xl text-white"></i>
                </div>
              </div>
              <div className="md:w-2/3 p-8">
                <div className="flex justify-between items-start mb-4">
                  <span className="saffron-text text-sm font-semibold">Nov {i}, 2025</span>
                  <span className="bg-orange-100 text-orange-800 text-xs font-medium px-3 py-1 rounded-full">Inspiration</span>
                </div>
                <h3 className="text-2xl font-bold mb-4 text-gray-800">Story Title {i}: A Journey of Hope and Transformation</h3>
                ...
                <div className="flex items-center justify-between">
                  <button className="saffron-text font-semibold hover:text-orange-700 flex items-center gap-2">
                    Read Full Story <i className="fas fa-arrow-right"></i>
                  </button>
                  <div className="flex space-x-2 text-orange-400">
                    <i className="fas fa-share-alt cursor-pointer hover:text-orange-600"></i>
                    <i className="far fa-heart cursor-pointer hover:text-orange-600"></i>
                  </div>
                </div>
              </div>
            </div>
