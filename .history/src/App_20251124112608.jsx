...
const OurCausesLandingPage = () => (
  <div className="min-h-screen bg-[#F9FAFB] text-slate-800 font-sans selection:bg-emerald-100">
    {/* Minimal Navigation (No Logo/Icons) */}
    <div className="bg-white border-b border-slate-200 sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="font-bold text-xl tracking-tight text-emerald-800">
          SABRI HELPAGE
        </div>
        <div className="flex gap-8 text-sm font-medium text-slate-500">
          <button className="hover:text-emerald-700 transition-colors">Mission</button>
          <button className="hover:text-emerald-700 transition-colors">SocioFare</button>
          <button className="bg-emerald-700 text-white px-5 py-2 rounded hover:bg-emerald-800 transition-colors">
            Support Us
          </button>
        </div>
      </div>
    ...
    {/* Philosophy Intro - Replacing Standard Hero */}
    <div className="max-w-3xl mx-auto px-6 pt-24 pb-16">
      <p className="text-emerald-700 font-medium mb-4 uppercase tracking-widest text-xs">
        Serving Society for Over a Decade
      </p>
      <h2 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-8">
        We believe that charity should not be a duty, but a natural responsibility of every human being.
      </h2>
      <div className="prose prose-lg text-slate-600">
        <p>
          Based in Kolkata, Sabri Helpage operates independently of business, religious, or political influence. Our work is grounded in the reality of the streets—from the abandoned elderly in our cities to the street children denied their basic right to dignity.
        </p>
      </div>
    </div>
    ...
    <div className="bg-white border-y border-slate-100">
      <div className="max-w-5xl mx-auto px-6 py-20 flex flex-col md:flex-row gap-12 items-start">
        <div className="md:w-1/3">
          ...
          <h3 className="text-3xl font-bold text-slate-900 mb-2">Elderly Care</h3>
          <p className="text-slate-400 italic">"Making their golden years truly golden"</p>
        </div>
        <div className="md:w-2/3">
          ...
          <ul className="space-y-4 mb-8">
            <li className="flex gap-4">
              ...
              <span className="text-slate-600"><strong>Legal & Medical Support:</strong> Assisting abandoned seniors with legal counseling to claim their rights and providing free geriatric healthcare.</span>
            </li>
            <li className="flex gap-4">
              <span className="text-emerald-600 font-bold">02.</span>
              <span className="text-slate-600"><strong>Combating Isolation:</strong> Organizing community events and recreational centers where seniors can socialize and regain their dignity.</span>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className="bg-[#F0FDF4] border-b border-emerald-100">
      <div className="max-w-5xl mx-auto px-6 py-20 flex flex-col md:flex-row gap-12 items-start">
        <div className="md:w-1/3">
          <div className="h-1 w-12 bg-emerald-500 mb-6"></div>
          <h3 className="text-3xl font-bold text-slate-900 mb-2">Girl Child & Education</h3>
          <p className="text-slate-500 italic">"Empowering the street child"</p>
        </div>
        <div className="md:w-2/3">
          <p className="text-lg text-slate-700 mb-6 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-emerald-100">
              <h4 className="font-bold text-slate-900 mb-2">Hygiene & Dignity</h4>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-emerald-100">
              <h4 className="font-bold text-slate-900 mb-2">Skill Development</h4>
              <p className="text-sm text-slate-600">
                Beyond basic literacy, we provide vocational training to ensuring these girls can secure safe, dignified employment as they reach adulthood.
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="bg-white border-b border-slate-100">
      <div className="max-w-5xl mx-auto px-6 py-20 flex flex-col md:flex-row gap-12 items-start">
        <div className="md:w-1/3">
          <div className="h-1 w-12 bg-emerald-500 mb-6"></div>
          <h3 className="text-3xl font-bold text-slate-900 mb-2">Mental Health Awareness</h3>
          <p className="text-slate-400 italic">"Breaking the silence"</p>
        </div>
        <div className="md:w-2/3">
          <p className="text-lg text-slate-700 mb-6 leading-relaxed">
    ...
    <div className="bg-slate-900 text-white">
      <div className="max-w-5xl mx-auto px-6 py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-6 text-emerald-400">The SocioFare Awards</h2>
            ...
            <p className="text-slate-400 mb-8">
              From individual changemakers to impactful organizations, SocioFare honors the unsung heroes building a better India.
            </p>
            <button className="border border-white text-white px-6 py-3 hover:bg-white hover:text-slate-900 transition-colors">
              Nominate a Changemaker
            </button>
          </div>
          <div className="border border-slate-700 p-8 rounded-xl bg-slate-800/50">
            <h4 className="text-xl font-bold mb-4 text-emerald-400">Impact by the Numbers</h4>
            <div className="space-y-6">
              <div>
                <div className="text-4xl font-bold mb-1">50,000+</div>
                <div className="text-slate-400 text-sm">Lives impacted across Bengal</div>
              </div>
              <div className="w-full bg-slate-700 h-px"></div>
              <div>
                <div className="text-4xl font-bold mb-1">10+</div>
                <div className="text-slate-400 text-sm">Years of relentless service</div>
              </div>
              <div className="w-full bg-slate-700 h-px"></div>
              <div>
                <div className="text-4xl font-bold mb-1">25+</div>
                <div className="text-slate-400 text-sm">Regions covered</div>
              </div>
            </div>
          </div>
        </div>
    ...
    {/* Simple Footer */}
    <div className="bg-white py-12 px-6 border-t border-slate-200">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="text-slate-500 text-sm">
          © 2024 Sabri Helpage. All rights reserved. <br/>
          Registered Non-Profit Organization (Kolkata).
        </div>
        <div className="flex gap-6 text-slate-500 text-sm">
          <span className="cursor-pointer hover:text-emerald-700">Privacy Policy</span>
          <span className="cursor-pointer hover:text-emerald-700">Financial Transparency</span>
          <span className="cursor-pointer hover:text-emerald-700">Contact</span>
        </div>
      </div>
    </div>
  </div>
