        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Milestones and Video */}
                      {/* Milestones and Video Section */}
      <section className="py-16 md:py-24 bg-gray-50 relative overflow-hidden">
        
        {/* Decorative Background Pattern (Subtle Dots) to unify the layout */}
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(#000 1px, transparent 1px)', backgroundSize: '24px 24px' }}></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          
          {/* Changed items-stretch to items-center to fix the "random" alignment */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            
            {/* --- LEFT COLUMN: The Info Card --- */}
            <div className="flex flex-col">
              <div 
                className="p-8 md:p-10 rounded-3xl shadow-2xl flex flex-col relative overflow-hidden group" 
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <p className="text-xs font-bold uppercase tracking-widest text-white">Our Impact</p>
                  </div>

                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-10 leading-[1.1]">
                    We've Accomplished <br className="hidden lg:block"/> Most During This Span.
                  </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {[
                      ...
                      <div 
                        key={idx} 
                        className="p-4 rounded-2xl border border-white/10 backdrop-blur-sm bg-black/10 transition-transform duration-300 hover:-translate-y-1" 
                      >
                        <span className="block text-2xl md:text-3xl font-extrabold text-white">{stat.value}</span>
                        <span className="block text-[10px] font-bold text-white/70 uppercase mt-1 tracking-wider">{stat.label}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            {/* --- RIGHT COLUMN: The Media Stack --- */}
            <div className="flex flex-col gap-6">
              
              {/* VIDEO CARD: Added white background frame to make it look like a photo object */}
              <div className="bg-white p-3 rounded-[2rem] shadow-xl border border-gray-200 transform transition-transform hover:scale-[1.02] duration-500">
                <div className="relative w-full overflow-hidden rounded-[1.5rem] aspect-video bg-gray-900 shadow-inner">
                   <YoutubeEmbed videoId={YOUTUBE_VIDEO_ID} title="Sabri Helpage Story" />
                </div>
              </div>

              {/* ACTION BUTTON: Aligned perfectly below the video frame */}
              <a 
                href="https://www.youtube.com/@YourChannel" 
                target="_blank" 
                rel="noopener noreferrer"
                className="group flex items-center justify-between bg-white p-2 pr-6 rounded-full shadow-md border border-gray-100 hover:shadow-xl hover:border-red-100 transition-all duration-300"
              >
                <div className="flex items-center gap-4">
                  {/* Icon Circle */}
                  <div className="w-12 h-12 flex items-center justify-center bg-red-50 rounded-full group-hover:bg-red-600 transition-colors duration-300">
                     <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-red-600 group-hover:text-white transition-colors duration-300">
                  ...
                  {/* Text Label */}
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Join our community</span>
                    <span className="text-sm font-bold text-gray-900 group-hover:text-red-600 transition-colors">Visit YouTube Channel</span>
                  </div>
                </div>

                {/* Arrow */}
                <div className="transform group-hover:translate-x-1 transition-transform">
                  <svg className="w-5 h-5 text-gray-300 group-hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
