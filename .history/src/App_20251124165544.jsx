        ...
        <div className="flex justify-between items-center py-2 md:py-3">
          ...
          >
           <img 
            ...
            className="h-[33.6px] md:h-[39.2px] object-contain transition-transform hover:scale-105"
           />
          </button>

          {/* CHANGES START HERE */}
          <div className="hidden lg:flex items-center space-x-6"> 
            <nav className="flex space-x-8 text-sm font-bold uppercase tracking-wide text-gray-700"> {/* Added space-x-8 here */}
              {navItems.map(item => (
                <button
                  key={item.name}
