  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
      ...
      >
        ...
        <div className="p-6 md:p-10 rounded-2xl shadow-2xl h-full flex flex-col relative overflow-hidden" style={{ backgroundColor: COLORS.ACCENT_ORANGE }}>
          
          {/* Decorative subtle circle for texture */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-white opacity-10 rounded-full blur-2xl transform translate-x-10 -translate-y-10"></div>

          <p className="text-sm font-bold uppercase tracking-widest text-white/90 mb-3">OUR MILESTONES</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mt-auto">
            {[
              ...
              <motion.div 
                ...
                className="p-4 rounded-xl text-center border border-white/10" 
                style={{ backgroundColor: COLORS.PRIMARY_DARK }}
              >
      ...
      >
        ...
        <div className="relative w-full shadow-2xl rounded-2xl overflow-hidden h-96 group border-4 border-white bg-gray-100">
          
          <YoutubeEmbed videoId={YOUTUBE_VIDEO_ID} title="Sabri Helpage Story" />

          {/* COOL YOUTUBE FLOATING BUTTON */}
          <a 
            href="https://www.youtube.com/@YourChannel" 
            target="_blank"
            rel="noopener noreferrer"
            className="absolute bottom-4 right-4 z-20 flex items-center gap-3 bg-white px-4 py-2.5 rounded-full shadow-lg hover:shadow-red-500/30 hover:-translate-y-1 transition-all duration-300 group/btn"
          >
            <div className="relative flex items-center justify-center">
               <Youtube className="w-6 h-6 text-red-600 fill-red-600 group-hover/btn:scale-110 transition-transform" />
            </div>
            <div className="flex flex-col">
                <span className="text-[10px] font-bold uppercase text-gray-400 leading-none">Subscribe</span>
                <span className="text-sm font-bold text-gray-900 leading-tight">My Channel</span>
            </div>
          </a>
