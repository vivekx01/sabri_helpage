...
import { SOCIAL_LINKS, COLORS } from '../../../src/constants/config';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-6 text-xs text-gray-400">
             <button onClick={() => onNavigate && onNavigate('about')} className="hover:text-white transition">About </button>
            <button onClick={() => onNavigate && onNavigate('terms')} className="hover:text-white transition">Terms of Use</button>
            <button onClick={() => onNavigate && onNavigate('privacy')} className="hover:text-white transition">Privacy Policy</button>
          </div>
        </div>
      </div>
    </footer>
