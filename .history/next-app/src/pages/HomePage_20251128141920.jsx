...
import { COLORS, IMAGE_URLS, YOUTUBE_VIDEO_ID } from '../../src/constants/config';
        ...
        <div key={idx} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-500 transform hover:-translate-y-2">
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3">
              <button 
                onClick={() => onNavigate && onNavigate(cause.route)}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {newsItems.map((story) => (
              <div key={story.title} className="group cursor-pointer" onClick={() => onNavigate && onNavigate('blog')}>
