...
const adminJs = new AdminJS({
  resources: [
    ...
    { resource: PageContent, options: { actions: { edit: { isAccessible: isAdmin }, new: { isAccessible: isAdmin }, delete: { isAccessible: isSuperAdmin } } } },
    // Editable Cause Content
    { resource: CauseContent, options: { actions: { edit: { isAccessible: isAdmin }, new: { isAccessible: isAdmin }, delete: { isAccessible: isSuperAdmin } } } },
    // Testimonials
    { resource: Testimonial, options: { actions: { edit: { isAccessible: isAdmin }, new: { isAccessible: isAdmin }, delete: { isAccessible: isSuperAdmin } } } },
