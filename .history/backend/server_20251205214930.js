  ...
  try {
    ...
    res.json({
      ...
      env: {
        ...
        MONGODB_URI: process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://localhost:27017/sabrihelpage',
...
const start = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`🔗 CORS_ORIGIN: ${process.env.CORS_ORIGIN || 'any'}`);
      console.log(`🗄️  MONGODB_URI: ${process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://localhost:27017/sabrihelpage'}`);
