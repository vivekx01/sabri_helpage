...
const educationPageSchema = new mongoose.Schema({
  name: { type: String, default: 'Education' },
  slug: { type: String, default: 'education' },
  hero: {
    title: { type: String, default: 'Transforming Lives Through Education' },
    backgroundImage: { type: String, default: '/images/education/hero-bg.jpg' },
